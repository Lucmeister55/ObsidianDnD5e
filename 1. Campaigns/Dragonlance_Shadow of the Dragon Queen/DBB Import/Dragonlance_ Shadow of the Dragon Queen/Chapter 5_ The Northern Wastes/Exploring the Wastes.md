---
title: "Exploring the Wastes"
icon: ":sticky-note:"
aliases: "Exploring the Wastes"
foundryId: JournalEntry.0me20wIZIbtXGkcO.JournalEntryPage.C9JpCILGAEaAGFIa
tags:
  - JournalEntryPage
---
...
![[ddb-images-adventures-Dragonlance__Shadow_of_the_Dragon_Queen-assets-map-5.01-kalaman-and-northern-wastes.png]]

Map 5.1: kalaman and northern wastes
...
The ship is small but seaworthy, with enough room for a dozen crew members. It has nothing of value on its deck or in the communal bunks below deck. However, two [air elementals](https://www.dndbeyond.com/monsters/air-elementals) on the deck defend the vessel against intruders. They attack any non-elf that sets foot upon the ship.

If the characters haven’t met Dalamar yet (see the following section), he’s nearby when they board the ship, and an [[Alarm|alarm]] spell cast on the deck alerts him to their intrusion. He might approach them anytime after they defeat the elementals (see the following section).
...
*   If the characters mention the City of Lost Names, he pretends not to recognize the name until he knows more about the characters (see the “[[Exploring the Wastes#Mutual Understanding|Mutual Understanding]]” section). A character who succeeds on a DC 14 Wisdom (Insight) check believes Dalamar knows more than he says.
*   Dalamar invites the characters to return with him to his group at the [[Exploring the Wastes#B: Elven Encampment|elven encampment]] (location B on [[Exploring the Wastes|map 5.1]]).

##### Dalamar

![[ddb-images-adventures-Dragonlance__Shadow_of_the_Dragon_Queen-assets-05-003.dalamar.png]]

Dalamar provides a glimpse  
of lost, ancient ruins

An ambitious elf magic-user, Dalamar (neutral elf [mage](https://www.dndbeyond.com/monsters/mage)) has an insatiable thirst for knowledge. This often puts him at odds with other Silvanesti mages, whose conservative methods wear on his patience.
...
_**Personality Trait.**_ “Everybody wants something. I’m certain we can help one another.”

_**Ideal.**_ “Magic is meant to be used.”

_**Bond.**_ “I’ll do anything to recover my home.”

_**Flaw.**_ “I’m overconfident, sometimes to the point of putting myself or others in danger.”
...
The elven camp lies next to some small ruins on a plateau overlooking the wastes, with a dozen or so tents arranged in a spiral pattern. Ten elves are present in the camp when the characters arrive, including their leader, Zhelsuel. Others roam the wastes in search of information. They all use the [mage](https://www.dndbeyond.com/monsters/mage) stat block.
...
_**Personality Trait.**_ “I know what’s best for my people, and I lead with logic and precision.”

_**Ideal.**_ “I take pride in work done to perfection.”

_**Bond.**_ “I’ll show my people what I can do. My name won’t be forgotten.”

_**Flaw.**_ “I won’t accept any course of action that doesn’t put the best interest of Silvanesti first.”
...
*   Zhelsuel shares any of the information from the “[[Exploring the Wastes#Silvanesti’s Exiles|Silvanesti’s Exiles]]” or “[[Exploring the Wastes#Zhelsuel|Zhelsuel]]” sections.
...
Ishvern and the [sea elves](https://www.dndbeyond.com/monsters/sea-elves) use the [scout](https://www.dndbeyond.com/monsters/scout) stat block with the following changes:
...
![[ddb-images-adventures-Dragonlance__Shadow_of_the_Dragon_Queen-assets-05-004.ishvern.png]]

Ishvern

Ishvern (neutral good, [sea elf scout](https://www.dndbeyond.com/monsters/sea-elfscout)), the de facto leader of the Dimernesti group in their priest’s absence, is pious, curious, and insightful. Having survived in the deadliest depths of the Turbidus Ocean for over a century, he knows better than to venture into mysterious places unprepared. He isn’t eager to risk his companions’ lives without the priest Yearkal’s guidance. However, Ishvern fears Yearkal might be lost forever. If others might aid him in fulfilling her spiritual mission, he’s eager for their help.

_**Personality Trait.**_ “Embrace the world’s wonders, but be wary of its dangers.”

_**Ideal.**_ “Life and nature are marvels that must be protected at all costs.”

_**Bond.**_ “I will find my missing companions.”

_**Flaw.**_ “I can be indecisive when choosing between options with uncertain outcomes.”
...
_**Yearkal’s Return.**_ If the characters know of Yearkal’s fate or return her to the group (see the “[[Exploring the Wastes#D: Sunward Fortress|D: Sunward Fortress]]” section), the elves encourage the characters to come with them into the shrine. If Yearkal is with them, she knows all the threats and secret passages in [[Exploring the Wastes#C1: Shrine Entrance|areas C1]] through [[Exploring the Wastes#C4: Hall|area C4]].
...
**Light.** All areas of the shrine are brightly lit by blue [[Continual Flame|continual flame]] spells cast on seashells and other objects embedded in the walls.

**Walls and Doors.** The shrine’s walls and doors are made of solid stone. Except for the door in [[Exploring the Wastes#C1: Shrine Entrance|area C1]], the doors throughout the shrine open easily.

**Water.** The Wash is low when the characters reach the shrine, but each room is filled with 2 feet of standing water, except for [[Exploring the Wastes#C5: Crypt|area C5]]. Areas with standing water are difficult terrain.

#### Shrine Locations

The following locations are keyed to map 5.2.

![[ddb-images-adventures-Dragonlance__Shadow_of_the_Dragon_Queen-assets-map-5.02-blue-phoenix-shrine.png]]

Map 5.2: blue phoenix shrine
...
_**Shrine Door.**_ Ishvern explains Yearkal opened this door by saying a specific prayer, but he doesn’t know it. If a character says the name “Habbakuk” within 10 feet of the door, it swings open magically. Casting the [[Knock|knock]] spell also opens the door.
...
_**Altar Guardians.**_ If a character comes within 10 feet of the altar without having washed themself in area C3 within the last 24 hours, three [water weirds](https://www.dndbeyond.com/monsters/water-weirds) rise from the water between the pillars. They are hostile toward any Humanoid who doesn’t openly bear the symbol of Habbakuk. The water weirds cease attacking and vanish if a creature in the room uses an action to apologize to Habbakuk or speak a prayer to the god’s name.
...
_**Secret Door.**_ This crypt is seemingly a dead end. A character who has a passive Wisdom (Perception) score of 20 or higher notices the secret door if they come within 5 feet of it. The [[Detect Magic|detect magic]] spell also reveals the secret door.

The secret door magically opens if a character obeys the inscription on door in area C4 and prays or makes an offering at either sarcophagus. Casting the [[Dispel Magic|dispel magic]] or [[Knock|knock]] spell also makes it easy to push the door open. The door is a Large object with AC 17, 40 hit points, and immunity to poison and psychic damage.
...
_**Shrine Guardians.**_ If a character who didn’t wash in [[Exploring the Wastes#C3: Cleansing Room|area C3]] or who opened a sarcophagus in area C4 comes within 10 feet of the well, the algae on the walls coalesces into three [black puddings](https://www.dndbeyond.com/monsters/black-puddings) that immediately attack the offending character as well as other creatures that attack the puddings.

_**Ishvern’s Offering.**_ So long as there are no obvious threats in this room, Ishvern moves to the side of the well, softly speaks a brief prayer in Elvish, then empties several dozen blue pearls from a pouch into the well (he retains 750 gp worth of pearls just in case). After he does so, each character in the room who washed themself in area C3 and who didn’t disturb the sarcophagi in area C5 gains the charm Habbakuk’s Blessing (a type of [supernatural gift](https://www.dndbeyond.com/sources/dnd/dmg-2014/other-rewards#SupernaturalGifts#SupernaturalGifts) detailed in the Dungeon Master’s Guide; see below). With this done, Ishvern thanks the characters for helping him complete his party’s task and prepares to depart.
...
Additionally, while traveling, you and up to 5 other creatures with you ignore difficult terrain outdoors in the Northern Wastes, allowing you to move at double the pace listed on the [[Into the Wastes#Northern Wastes Land Travel|Northern Wastes Land Travel]] table (see the “[[Into the Wastes]]” section earlier in this chapter).
...
As the group leaves the shrine, if the characters haven’t already rescued the sea elves at Camp Carrionclay, a [sea elf scout](https://www.dndbeyond.com/monsters/sea-elfscout) approaches Ishvern to tell him they’ve found where their captured companions were taken. The sea elves have been imprisoned at a Dragon Army camp in the middle of a murky lake (see the “[[Exploring the Wastes#I: Camp Carrionclay|I: Camp Carrionclay]]” section). These sea elf scouts provide directions to area I on [[Exploring the Wastes|map 5.1]]. Mark this hex on the players’ map of the region in [[Appendix E\_ Maps|appendix E]].
...
At the base of the spire’s remains stand a dozen ragged canvas tents in the red and black colors of the Red Dragon Army. Dozens of empty or shattered crates are scattered amid the camp. Nearby, an earthen ramp cuts through the clay and leads to an opening into the ruined spire’s foundation. This opening leads to [[Exploring the Wastes#D1: Entry Chamber|area D1]].

_**Abandoned Gear.**_ Characters who spend 10 minutes investigating the tents find enough dried meat to sustain one person for ten days, twelve dirty [shovels](https://www.dndbeyond.com/equipment/shovels), an overturned wheelbarrow, and a suit of [leather armor](https://www.dndbeyond.com/equipment/leather-armor) bearing the Dragon Queen’s symbol.

_**Mysterious Markings.**_ A character who has a passive Wisdom (Survival) score of 16 or higher notices two types of clawed footprints amid the camp. Some are roughly human-sized, while others are twice that size. Characters who have seen draconian footprints before recognize the smaller prints as draconian. The characters likely have no way of knowing the larger prints are slaadi tracks.

_**Resting near Camp.**_ If the characters take a long rest in the camp or within a mile of the Sunward Fortress, there is a 50 percent chance they are attacked by two [red slaadi](https://www.dndbeyond.com/monsters/red-slaadi) that fight to the death.
...
![[ddb-images-adventures-Dragonlance__Shadow_of_the_Dragon_Queen-assets-map-5.03-sunward-fortress.png]]

Map 5.3: sunward fortress
...
_**Altar.**_ A cleric of Sirrion or a character who succeeds on a DC 14 Intelligence (Religion) check recognizes the symbols on the altar as holy to Sirrion, god of creativity and change. A character who speaks an earnest prayer to Sirrion causes flames to spring to life within the altar’s candle sconces and a thick, red liquid to fill its basin. This liquid is a [potion of fire breath](https://www.dndbeyond.com/magic-items/potion-offirebreath). After creating this potion, the altar won’t do so again until one month has passed.

_**Stairs.**_ The stairs here descend to [[Exploring the Wastes#D3: Lower Chambers|area D3]].
...
The Dragon Army’s prisoners rested here before slaadi destroyed the room. A character who spends five minutes searching the debris finds bits of clothing, two sets of [manacles](https://www.dndbeyond.com/equipment/manacles), and a blue pearl worth 150 gp.
...
_**Equipment.**_ The crates hold dozens of tools. A character who spends ten minutes searching the equipment finds three [bullseye lanterns](https://www.dndbeyond.com/equipment/bullseye-lanterns), six [flasks of oil](https://www.dndbeyond.com/equipment/flasks-ofoil), 100 feet of [hempen rope](https://www.dndbeyond.com/equipment/hempen-rope), four [vials of acid](https://www.dndbeyond.com/equipment/vials-ofacid), and three sets of [mason’s tools](https://www.dndbeyond.com/equipment/masons-tools).

_**Dracophage Subjects.**_ Four mutated [draconian-slaad hybrids](https://www.dndbeyond.com/monsters/draconian-slaad-hybrids) lurk in the east hall. They look like bloated draconians with bright-red skin and wide, frog-like mouths. These creatures use the [kapak draconian](https://www.dndbeyond.com/monsters/kapak-draconian) stat block (see [[Creatures#Kapak Draconian|appendix B]]), but replace their Dagger attack with the following attack:

_**Claw.** Melee Weapon Attack:_ 1d20 + 5 to hit, reach 5 ft., one target. _Hit:_

A Humanoid host can carry only one slaad egg at a time. Over three months, the egg moves to the chest cavity, gestates, and forms a [slaad tadpole](https://www.dndbeyond.com/monsters/slaad-tadpole). In the 24-hour period before the tadpole is born, the host feels unwell; its speed is halved; and it has disadvantage on attack rolls, ability checks, and saving throws. At birth, the tadpole chews its way through vital organs and out of the host’s chest in 1 round, killing the host in the process.

If the disease is cured before the tadpole’s emergence, the tadpole disintegrates.

_**Stairs.**_ In the northwest corner of the level, stairs descend to [[Exploring the Wastes#D5: Spire Depths|area D5]].

##### D4: Barricaded Room

The entrance to this room is barricaded by heavy mining equipment. Inside are two Dragon Army captives who escaped the initial slaadi attack and Virruza (see area D5 for details). A character can unblock the door by succeeding on a DC 17 Strength check, but doing so alerts the [hybrid draconians](https://www.dndbeyond.com/monsters/hybrid-draconians) in area D3. If the characters try to speak through the crates, Yearkal answers them in a whisper, urging them to keep quiet.

_**Survivors.**_ The Dimernesti sea elf Yearkal (neutral good, sea elf [acolyte](https://www.dndbeyond.com/monsters/acolyte); see the “[[Exploring the Wastes#C: Blue Phoenix Shrine|C: Blue Phoenix Shrine]]” section for details on sea elves) hides inside the room with the unconscious Rone (neutral, human [scout](https://www.dndbeyond.com/monsters/scout)), a hunter from Heart’s Hollow. Rone has been infected with an ailment Yearkal doesn’t know how to treat (see “Rone’s Fate” below).
...
_**Rone’s Fate.**_ Rone is infected with a slaad tadpole. Due to Virruza’s experiments, the tadpole matured rapidly and is about to hatch. A character who succeeds on a DC 18 Intelligence (Arcana or Medicine) check realizes Rone is infected by a dangerous parasite that will soon kill him, though a [[Lesser Restoration|lesser restoration]] spell or similar magic could heal him.

If the characters don’t heal Rone, a [slaad tadpole](https://www.dndbeyond.com/monsters/slaad-tadpole) emerges 1 hour after the characters encounter him, killing him. If the characters do heal Rone, he thanks them and offers them a 1,000 gp reward if they take him home to Heart’s Hollow.
...
The creature is a [red slaad](https://www.dndbeyond.com/monsters/red-slaad) covered in five [slaad tadpoles](https://www.dndbeyond.com/monsters/slaad-tadpoles). These monsters attack as soon as they spot the characters. A character who succeeds on a DC 16 Intelligence (Arcana) check recognizes the monsters as slaadi, denizens of the plane of Limbo.

![[ddb-images-adventures-Dragonlance__Shadow_of_the_Dragon_Queen-assets-05-005.red-slaad-covered-tadpoles.png]]
...
_**Chasm and Bridges.**_ The chasm drops 70 feet to an uneven stone floor below. A creature that falls into the chasm takes 24 (7d6) Bludgeoning damage.
...
_**Virruza.**_ Changed by days of strange experiments involving draconian blood and exposure to the Spawning Shard, Virruza now looks like a tumescent draconian with warty green skin and an overly large mouth. Use the [green slaad](https://www.dndbeyond.com/monsters/green-slaad) stat block for [Virruza](https://www.dndbeyond.com/monsters/virruza), but replace the Shapechanger trait with the following trait:

_**Death Throes.**_ When Virruza is reduced to 0 hit points, he turns into a puddle of acid and splashes acid on those around him. Each creature within 5 feet of him must succeed on a DC 12 Dexterity saving throw or be covered in acid for 1 minute. A creature can use its action to scrape or wash the acid off itself or another creature. A creature covered in the acid takes 7 (2d6) Acid damage at the start of each of its turns.

Virruza is hostile, is unable to communicate intelligibly, and fights to the death.

_**Spawning Shard.**_ This enormous orange gem weighs over a ton and sheds dim light for 10 feet. A [[Detect Magic|detect magic]] spell reveals it emanates an aura of transmutation magic. A character who inspects the Spawning Shard and succeeds on a DC 18 Intelligence (Arcana) check determines the gem’s magic can corrupt creatures and turn them into slaadi.

A creature that touches the gem must succeed on a DC 15 Constitution saving throw or become infected with a disease called chaos phage. While infected, the target can’t regain hit points, and its hit point maximum is reduced by 3d6 every 24 hours unless the target is cured by magic such as the [[Lesser Restoration|lesser restoration]] spell. If the disease reduces the target’s hit point maximum to 0, the target instantly transforms into a [red slaad](https://www.dndbeyond.com/monsters/red-slaad) or, if it has the ability to cast spells of 3rd level or higher, a [green slaad](https://www.dndbeyond.com/monsters/green-slaad). Only a [[Wish|wish]] spell can reverse the transformation.

_**Treasure.**_ Virruza carries a pouch containing 900 gp worth of nonmagical orange gemstones—they aren’t related to the Spawning Shard, though they look similar. He also carries a [+1 wand of the war mage](https://www.dndbeyond.com/magic-items/1-wandofthewarmage) he has forgotten how to use.
...
If the characters want to seal the entrance to the Sunward Fortress or otherwise bury the Spawning Shard, the equipment left around the ruins allows them to collapse the ramp leading to [[Exploring the Wastes#D1: Entry Chamber|area D1]] with four hours of effort. Destructive magic hastens this work.
...
The ancient door here opens into [[Exploring the Wastes#E1: First Level|area E1]].

![[ddb-images-adventures-Dragonlance__Shadow_of_the_Dragon_Queen-assets-map-5.04-wakenreth.png]]
...
**Lighting.** [[Exploring the Wastes#E1: First Level|Areas E1]] and [[Exploring the Wastes#E2: Second Level|area E2]] are brightly lit by [[Continual Flame|continual flame]] spells cast on wall sconces. In [[Exploring the Wastes#E3: Third Level|areas E3]] and [[Exploring the Wastes#E4: Fourth Level|area E4]], these glowing sconces are affected by Shadowfell magic that causes them to produce only dim light and shine with an eerie green glow. [[Exploring the Wastes#E5: Shadowfell Expanse|Area E5]] is dimly lit by a gloomy gray sky.

#### Wakenreth Locations

The following locations are keyed to map 5.4, except for [[Exploring the Wastes#E5: Shadowfell Expanse|area E5]], which is unmapped.
...
_**Cursed.**_ A character who proceeds up the stairs without leaving a coin on the pedestal or who takes a coin from the room becomes cursed for as long as they remain within the tower or until the curse is removed by a [[Remove Curse|remove curse]] spell or similar magic. While cursed, the character has disadvantage on all ability checks and saving throws.

_**Stairs.**_ The stairs here climb up to area E2.

_**Treasure.**_ There are 451 silver coins in this room, which a character can collect by spending ten minutes. However, a character who removes a coin from this room becomes cursed as noted above.
...
The characters draw the attention of two hostile [wraiths](https://www.dndbeyond.com/monsters/wraiths) that lurk inside the crypts here. Once each wraith is defeated, it turns into an incorporeal elven spirit. One spirit quickly fades away, while the other—a woman with light-gray hair and pale eyes—floats through the ceiling and out of sight.

_**Stairs and Ceiling.**_ The door here leads to stairs once used to access area E3. However, the stairs are blocked by rubble that would take hours to clear. The hole in the ceiling 20 feet above is the fastest way to access area E3.

_**Treasure.**_ The two crypts each hold a desiccated elven body. One body wears a [cloak of protection](https://www.dndbeyond.com/magic-items/cloak-ofprotection), while the other wears the nonmagical white robes of a Mage of High Sorcery.
...
_**Regretful Spirit.**_ The woman’s spirit repeatedly tries to pick up a sword from the remains on the floor, failing every time. She doesn’t notice the characters until she’s addressed directly, at which point she shares the following information in a distant, hollow voice:
...
*   She asks if the characters know her sister Tenadria, an elf diplomat who disappeared from the delegation. There’s no way the characters can know Tenadria, but her remains appear in [[The Flying Citadel#S9: Tenadria’s Tomb|chapter 7]].

After conversing with the characters, Jentida fades away.

_**Stairs.**_ The stairs leading down are blocked by rubble. The stairs leading up have a door at the top, which opens to area E4.

_**Treasure.**_ The sword the spirit was trying to pick up is a [dancing longsword](https://www.dndbeyond.com/magic-items/dancing-longsword). In addition, characters who search the remains in this room find six onyx gemstones worth 200 gp each.
...
_**Portal.**_ The archway was created to connect the tower with a friendly realm within the Feywild. When Wakenreth toppled from Onyari, though, its magic was disrupted. Now the portal connects to the Shadowfell.

A character who inspects the portal and succeeds on a DC 14 Intelligence (Arcana) check recognizes the sculpted dragon heads as those of green dragons, while the runes relate to the natural magic of the Feywild. They also notice the runes can rotate, likely as a means of controlling the portal, but their function is unclear. A character who attempts to adjust the runes without instructions from Veriel in area E5 must make the saving throw detailed in the “[[Exploring the Wastes#Restoring the Tower|Restoring the Tower]]” section, and they can’t close the portal yet.

A creature that steps through the portal appears in area E5 (an endless expanse not depicted on [[Exploring the Wastes|map 5.4]]). If no character steps through the portal, Veriel (see area E5) appears amid the mist in the arch and converses with the characters.
...
_**Veriel.**_ An elf spirit appears and greets the characters, introducing himself as Veriel (lawful neutral [ghost](https://www.dndbeyond.com/monsters/ghost)), Wakenreth’s caretaker. He explains to the characters what happened to the tower (detailed in “[[Exploring the Wastes#The Doomed Mausoleum|The Doomed Mausoleum]]” at the beginning of the “[[Exploring the Wastes#E: Wakenreth|E: Wakenreth]]” section). He knows nothing about the City of Lost Names or its location (as he’s unaware Onyari was later called that). Veriel asks for the party’s help in severing the link between Wakenreth and the Shadowfell, a feat that can be accomplished only from the other side of the portal. His time spent in the Shadowfell has linked him to this plane, and he can’t pass through the portal.

_**Undead Beast.**_ As Veriel relays this information, an [anhkolox](https://www.dndbeyond.com/monsters/anhkolox) (see [[Creatures#Anhkolox|appendix B]]) climbs into view from the tower’s edge, drawn by the activity here. Hungry for the characters’ life essence, the creature attacks. It ignores Veriel, who stays out of the fight.

_**The Shadowfell.**_ [The Shadowfell](https://www.dndbeyond.com/sources/dnd/dmg-2014/creating-a-multiverse#Shadowfell#Shadowfell) is detailed in the Dungeon Master’s Guide. Any exploration of the plane beyond the portal’s immediate vicinity is beyond the scope of this adventure.
...
*   If the characters haven’t done so already, he encourages them to investigate the [[Exploring the Wastes#C: Blue Phoenix Shrine|Blue Phoenix Shrine]] and the [[Exploring the Wastes#D: Sunward Fortress|Sunward Fortress]]—two sources of unique magic in the region.
...
![[ddb-images-adventures-Dragonlance__Shadow_of_the_Dragon_Queen-assets-05-006.grasha.png]]
...
![[ddb-images-adventures-Dragonlance__Shadow_of_the_Dragon_Queen-assets-map-5.05-bluemaw-cave.png]]

Map 5.5: bluemaw cave
...
_**Grick Pack.**_ The characters draw the attention of a pack of seven [gricks](https://www.dndbeyond.com/monsters/gricks) hiding in cracks in the walls. They were riled up and ultimately scared off from the lower chamber by the draconians. They attack the first creature they see.

The draconians in [[Exploring the Wastes#F3: Sand Pit|area F3]] have heard other draconians slaying gricks around the cave, so they ignore the sound of fighting above.
...
_**Grick Alpha.**_ If combat breaks out, a [grick alpha](https://www.dndbeyond.com/monsters/grick-alpha) and two [gricks](https://www.dndbeyond.com/monsters/gricks) that were dozing in the sand emerge in a random space adjacent to the quicksand. They indiscriminately attack any creatures in the room.

_**Treasure.**_ The draconians have removed much of the hoard’s treasure, but some remains in the sacks here and hidden beneath the sand. The draconians have gathered 700 gp in their sacks. Searching for and safely extracting what remains takes approximately six hours, unless the characters use magical means to move the sand, in which case the time can be reduced at your discretion. The remaining hoard includes 1,200 cp, 8,000 sp, 2,300 gp, 60 pp, twelve assorted gems worth 50 gp each, an ornate chalice worth 1,000 gp, and a pair of [boots of levitation](https://www.dndbeyond.com/magic-items/boots-oflevitation).
...
If the characters meet [[Exploring the Wastes#I4: Prisoner Cages|Kennah in Camp Carrionclay]] or [[Exploring the Wastes#D4: Barricaded Room|Rone in the Sunward Fortress]], they might seek Heart’s Hollow themselves. Otherwise, use the encounter in the following section whenever you please. Make sure the characters meet Clystran, as he plays a role in later chapters.
...
Clystran (neutral good, human [scout](https://www.dndbeyond.com/monsters/scout)) is being pursued by five [giant spiders](https://www.dndbeyond.com/monsters/giant-spiders) as the canyon floods (see “[[Into the Wastes#The Wash|The Wash]]” earlier in this chapter). You decide whether the characters are in the canyon as well or above it. The giant spiders turn their attention toward the characters if attacked, and they flee if three or more spiders are killed.
...
![[ddb-images-adventures-Dragonlance__Shadow_of_the_Dragon_Queen-assets-05-007.clystran.png]]

Clystran

##### Clystran

Clystran has lived his entire life in the Northern Wastes and considers himself an expert on the region. He knows dozens of interesting hollows and rock formations around High Hunt, the plateau that Heart’s Hollow occupies. He can share any of the local names for Northern Wastes regions, like “Wormgut” and “Giant’s Spine,” shown on [[Exploring the Wastes|map 5.1]]. He also considers himself an expert on the fauna of the Northern Wastes and takes a particular interest in the region’s wasteland dragonnels. Clystran claims he saw an actual dragon in his youth, leading to a lifelong search of the wastes for where such elusive creatures hide. No one in Heart’s Hollow takes his story or lifelong hunt seriously, though.

_**Personality Trait.**_ “I know all there is to know about the Northern Wastes, except where the dragons live.”

_**Ideal.**_ “I’ll become the best explorer in the wastes.”

_**Bond.**_ “Both the Northern Wastes and Heart’s Hollow are my home. I’m loyal to both.”

_**Flaw.**_ “I can probably squeeze down that hole—there might be a dragon’s lair inside!”
...
*   He’s happy to point the characters toward many landmarks in the Northern Wastes (see “[[Exploring the Wastes#Heart’s Hollow Quests|Heart’s Hollow Quests]]” for suggestions).
...
![[ddb-images-adventures-Dragonlance__Shadow_of_the_Dragon_Queen-assets-map-5.06-hearts-hollow.png]]

Map 5.6: hearts hollow
...
**End’s Odds.** Run by Grandit “End” Pike (neutral good, hill dwarf [commoner](https://www.dndbeyond.com/monsters/commoner)), End’s Odds sells “slightly used” goods and equipment found in the wastes.
...
**Lavender’s.** Lavender Jalls (lawful neutral, human [mage](https://www.dndbeyond.com/monsters/mage)) is a renegade wizard who hasn’t taken the Test of High Sorcery. He specializes in casting helpful cantrips and brewing alchemical tinctures.
...
The secretive dragon Nezrah (neutral good [adult bronze dragon](https://www.dndbeyond.com/monsters/adult-bronzedragon)) goes by the name Ness. She uses her magic to disguise herself as a middle-aged human woman, and no one knows she’s a dragon.
...
The people of Heart’s Hollow don’t know where the City of Lost Names is and have avoided the Dragon Army. They know the location of the [[Exploring the Wastes#C: Blue Phoenix Shrine|Blue Phoenix Shrine]], [[Exploring the Wastes#D: Sunward Fortress|Sunward Fortress]], and [[Exploring the Wastes#E: Wakenreth|Wakenreth]]. They’re also curious about other locations in the wastes and might ask for the characters’ help—see the locations below.

##### Bluemaw Cave Exploration

A group of scavengers have heard of [[Exploring the Wastes#F: Bluemaw Cave|Bluemaw Cave]] (location F on map 5.1), an out-of-the-way cavern where they’ve spotted dwarves living. They’d like to meet the dwarves and perhaps establish a friendly rapport. If the threats in the cave have not yet been defeated, the scavengers encourage the characters to clear them out, but they won’t participate in combat themselves.

##### Carrionclay Discovery

No one in Heart’s Hollow knows about [[Exploring the Wastes#I: Camp Carrionclay|Camp Carrionclay]] (location I on map 5.1). However, if the characters recover the dragon egg there and return to Heart’s Hollow, Ness urgently seeks them out. She pleads for the egg, swearing to keep it safe. She’ll even reveal her true nature to the characters if she needs to convince them she’ll be a worthy guardian, but she won’t threaten or harm them. If the characters agree to give her the egg, she rewards them with a suit of [bronze dragon scale mail](https://www.dndbeyond.com/magic-items/bronze-dragonscalemail) made from her own scales. She won’t interfere in the conflict with the Dragon Army, though.

##### Dragonnel Feeding

Clystran frequently takes dried meat to a flight of dragonnels he’s been watching for years. However, he hasn’t been able to visit for months and would like the characters’ help delivering several packs of food to his dragonnel friends. Their den is at [[Exploring the Wastes#H: Dragonnel Spire|location H]] on map 5.1. If the characters help him, Clystran will work for the characters as a scout (see “[[Exploring the Wastes#Heart’s Hollow Scouts|Heart’s Hollow Scouts]]”).
...
**Clystran the Guide.** If Clystran guides the characters in the Northern Wastes, the characters can ignore difficult terrain during travel, allowing them to cover double the distance listed on the [[Into the Wastes#Northern Wastes Land Travel|Northern Wastes Land Travel]] table earlier in this chapter. While with the characters, Clystran avoids combat and most dangerous situations.

**Scavengers as Guides.** A group of scavengers might temporarily join Darrett and his troops. These guides scout for the Kalaman forces through the Northern Wastes, allowing them to move at a normal pace of 12 miles (2 hexes on [[Exploring the Wastes|map 5.1]]) per day.

### H: Dragonnel Spire

Twelve [wasteland dragonnels](https://www.dndbeyond.com/monsters/wasteland-dragonnels) (see [[Creatures#Wasteland Dragonnel|appendix B]]) lair atop this rock formation, which looks like a dragon. Formations like this are common in the wastes, as if the spirits of the dragons killed during Onyari’s fall reshaped the land.
...
Characters might visit this location to rescue the sea elves they learn were captured in the “[[Exploring the Wastes#C: Blue Phoenix Shrine|C: Blue Phoenix Shrine]]” section. Alternatively, if the characters are defeated by Dragon Army soldiers, they’re brought here as prisoners.
...
**Sentries.** Three [Dragon Army soldiers](https://www.dndbeyond.com/monsters/dragon-armysoldiers) (see [[Creatures#Dragon Army Soldier|appendix B]]) keep watch from the central tower in [[Exploring the Wastes#I3: Watchtower|area I3]].

**Patrols.** Two groups of soldiers patrol the camp, each including a [Dragon Army officer](https://www.dndbeyond.com/monsters/dragon-armyofficer) and five [Dragon Army soldiers](https://www.dndbeyond.com/monsters/dragon-armysoldiers) (see [[Creatures#Dragon Army Troops|appendix B]] for both stat blocks). One group watches the bridge outside the walls, and the other monitors the interior.
...
**Posing as Soldiers.** Characters can attempt to gain entrance by disguising themselves with magic or the uniforms of soldiers they’ve defeated. See [[Exploring the Wastes#I2: Main Entrance|area I2]] for how such an attempt might unfold.

#### Camp Carrionclay Locations

The following locations are keyed to map 5.7.

![[ddb-images-adventures-Dragonlance__Shadow_of_the_Dragon_Queen-assets-map-5.07-camp-carrionclay.png]]

Map 5.7: camp carrionclay
...
The camp’s only gate is watched by a [sivak draconian](https://www.dndbeyond.com/monsters/sivak-draconian) and two [baaz draconians](https://www.dndbeyond.com/monsters/baaz-draconians) (see [[Creatures#Baaz Draconian|appendix B]] for both stat blocks).

_**Gaining Access.**_ If the characters disguise themselves as Dragon Army soldiers, they can attempt to deceive the draconians and enter the camp. The guards ask in Draconic where the characters are coming from. A character convinces the draconians to let them through with a successful DC 16 Charisma (Deception) check, made with disadvantage if the character doesn’t speak Draconic.
...
The watchtower is occupied by three [Dragon Army soldiers](https://www.dndbeyond.com/monsters/dragon-armysoldiers) (see [[Creatures#Dragon Army Soldier|appendix B]]). Due to the high vantage point, the soldiers’ passive Wisdom (Perception) score is 19.

_**Spotted.**_ If a sentry atop the watchtower spots suspicious individuals—such as those not wearing Dragon Army uniforms—they blow a horn to alert the patrols and gate guards in area I2.
...
The draconians keep prisoners in these cages. If the characters are captured, they’re imprisoned in a cage with Kennah. The cages are guarded by three [baaz draconians](https://www.dndbeyond.com/monsters/baaz-draconians) (see [[Creatures#Baaz Draconian|appendix B]]) and Urta, a [hobgoblin captain](https://www.dndbeyond.com/monsters/hobgoblin-captain) who serves as jailer.

_**Cages.**_ These cages are 10-foot cubes made of iron and locked with padlocks. Opening a lock requires the key held by Urta or a successful DC 17 Dexterity check using thieves’ tools. A character inside a cage has disadvantage on this check.

_**Sea Elves.**_ Two cages confine three Dimernesti sea elves, members of a group seeking the Blue Phoenix Shrine. Others in their group—including their leader, Yearkal—were taken to someplace called the [[Exploring the Wastes#D: Sunward Fortress|Sunward Fortress]]. The sea elves know this name but not where it is. However, they can guide the party to the [[Exploring the Wastes#C: Blue Phoenix Shrine|Blue Phoenix Shrine]].

_**Bulette.**_ One cage holds a recently captured [bulette](https://www.dndbeyond.com/monsters/bulette). It’s hostile to everyone. If freed, it goes on a rampage, attacking anyone and retreating into the ground once reduced to 15 hit points or fewer.

_**Kennah.**_ One cage houses Kennah, a [kender skirmisher](https://www.dndbeyond.com/monsters/kender-skirmisher) (see [[Creatures#Kender Skirmisher|appendix B]]) with 1 hit point and no weapons. Kennah is from Heart’s Hollow and was captured while scavenging the wastes. If freed, Kennah can take the characters to her settlement.
...
This hut belongs to Fewmaster Zirrok, the [hobgoblin warlord](https://www.dndbeyond.com/monsters/hobgoblin-warlord) in charge of the camp. Zirrok rarely leaves it. The hut is guarded by two [sivak draconians](https://www.dndbeyond.com/monsters/sivak-draconians) (see [[Creatures#Sivak Draconian|appendix B]]). Inside is a cot, a desk, and an ornate chest.

_**Desk.**_ The desk is covered in Dragon Army reports. A character who searches the desk finds letters from a commander named Belephaion talking about excavating the Sunward Fortress.

_**Ornate Chest.**_ Opening this chest requires either the key held by Fewmaster Zirrok or a successful DC 20 Dexterity check using thieves’ tools. The chest holds a bronze dragon egg, which will soon be claimed by an envoy of the evil cleric Belephaion (see “[[Exploring the Wastes#Wings of Death|Wings of Death]]”). If the characters give the egg to Nezrah (see “[[Exploring the Wastes#Heart’s Hollow Quests|Heart’s Hollow Quests]]”), she rewards them.

_**Treasure.**_ The desk holds two [potions of greater healing](https://www.dndbeyond.com/magic-items/potions-ofgreaterhealing) and a [pouch](https://www.dndbeyond.com/equipment/pouch) containing 300 gp.
...
The creature is Akhviri, an [adult black dragon](https://www.dndbeyond.com/monsters/adult-blackdragon) tasked with retrieving the dragon egg for Belephaion. If the characters haven’t left evidence of their presence, Akhviri waits for Fewmaster Zirrok to bring the chest from his tent to the watchtower.

_**True Dragon.**_ On Krynn, chromatic and metallic dragons are considered creatures of legend, and Akhviri is likely the first dragon the characters have encountered. Characters who haven’t encountered dragons before have disadvantage on saving throws against her Frightful Presence action.

_**Drawing Akhviri’s Attention.**_ Characters must succeed on a DC 21 group Dexterity (Stealth) check to avoid Akhviri’s notice. If something is visibly amiss at the camp (such as dead soldiers or signs of battle), the DC for this check increases to 26. If Akhviri spots the characters and they’re not disguised, she growls in Common from the tower:
...
Dread Wolf Cove is usually an unassuming inlet along the coast. However, the cove is lightly obscured by fog that billows from a nearby cave. If the characters enter, they encounter a wolflike [anhkolox](https://www.dndbeyond.com/monsters/anhkolox) (see [[Creatures#Anhkolox|appendix B]]). Should the characters battle the monster, Dalamar (neutral elf [mage](https://www.dndbeyond.com/monsters/mage)) aids them.

_**Shard of Darkness.**_ Once the anhkolox is destroyed, a character who searches the cave finds the source of the fog: a rounded piece of broken black glass. The fog ceases if the glass is touched, and it clears a minute later. A [[Detect Magic|detect magic]] spell reveals the shard emanates an aura of enchantment magic. A character who succeeds on a DC 20 Intelligence (Arcana) check realizes the glass is a remnant of a destroyed [Orb of Dragonkind](https://www.dndbeyond.com/magic-items/orb-ofdragonkind) (detailed in the Dungeon Master’s Guide). The shattered, incomplete artifact has no properties in its current state.
...
The characters learn the location of the City of Lost Names from Dalamar after completing the “[[Exploring the Wastes#E: Wakenreth|E: Wakenreth]]” section. The characters know the City of Lost Names is the Red Dragon Army’s destination. Before they head there, they should consider informing Darrett and their allies.
...
Wind’s End is the characters’ best chance to access the City of Lost Names. Wind’s End teems with patrols of [Dragon Army dragonnels](https://www.dndbeyond.com/monsters/dragon-armydragonnels) and [Dragon Army soldiers](https://www.dndbeyond.com/monsters/dragon-armysoldiers) (see [[Appendix B\_ Friends and Foes|appendix B]] for both stat blocks). If the characters want to sneak into Wind’s End, they’ll need a significant distraction.
...
**With Mass Combat.** If you are using the _Dragonlance: Warriors of Krynn_ game along with this adventure, consult the “Warriors of Krynn: Scenario 7” sidebar instead of running the “Attack on Wind’s End” section.

**Without Mass Combat.** If you aren’t using the _Dragonlance: Warriors of Krynn_ game, continue with the “Attack on Wind’s End” section.

WARRIORS OF KRYNN: SCENARIO 7

Darrett and the forces of Kalaman launch their attack on the Dragon Army. Things go well at first, but fate is against them, as an additional contingent of Dragon Army troops arrives soon after the battle begins. Read the introduction to scenario 7 in _Dragonlance: Warriors of Krynn_, then play that scenario. It details the attack on the Dragon Army forces at the walled canyon entrance to the City of Lost Names and the characters’ search for a secret path through.

At the end of the scenario, proceed with [[Chapter 6\_ City of Lost Names|chapter 6]] as the characters infiltrate the City of Lost Names.
...
Three [Dragon Army officers](https://www.dndbeyond.com/monsters/dragon-armyofficers) remain here with a [Dragon Army dragonnel](https://www.dndbeyond.com/monsters/dragon-armydragonnel) in a pen (see [[Appendix B\_ Friends and Foes|appendix B]] for both stat blocks). While the dragonnel is alert, the officers are distracted by the Kalaman forces and are surprised when the characters attack.

The “Wind’s End Battlefield Features” section notes elements of this battle. Soon after the characters attack, dragonnels from the City of Lost Names fly overhead. Some might notice the characters, adding additional threats to this battle (see the “[[Exploring the Wastes#Wind’s End Battlefield Events|Wind’s End Battlefield Events]]” section).
...
![[ddb-images-adventures-Dragonlance__Shadow_of_the_Dragon_Queen-assets-map-5.08-attack-on-winds-end.png]]

Map 5.8: attack on winds end
...
| d10 | Event |
| --- | --- |
| 1-4 | A [Dragon Army officer](https://www.dndbeyond.com/monsters/dragon-armyofficer) (see [[Creatures#Dragon Army Officer\|appendix B]]) on a dragonnel flies overhead, firing a heavy crossbow at the character closest to the Fray. The attack has a +4 bonus to hit and deals 7 (1d10 + 2) Piercing damage plus 5 (1d10) Fire damage on a hit. |
...
| 8-9 | Two [Dragon Army soldiers](https://www.dndbeyond.com/monsters/dragon-armysoldiers) (see [[Creatures#Dragon Army Soldier\|appendix B]]) arrive, appearing in unoccupied spaces adjacent to the Fray near a random player character. |
...
The characters will discover what dangers lie beyond this passage in [[Chapter 6\_ City of Lost Names|chapter 6]].

![[ddb-images-adventures-Dragonlance__Shadow_of_the_Dragon_Queen-assets-05-008.dragon-army-blockade.png]]
