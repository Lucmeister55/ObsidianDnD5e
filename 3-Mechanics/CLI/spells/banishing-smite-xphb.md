...
- **Casting time:** 1 Bonus Action, which you take immediately after hitting a creature with a Melee weapon or an [Unarmed Strike](/3-Mechanics/CLI/variant-rules/unarmed-strike-xphb.md)
- **Range:** Self
- **Components:** V
...
**Classes**: [Paladin (Oath of the Noble Genies)](/3-Mechanics/CLI/lists/list-spells-classes-oath-of-the-noble-genies-frhof.md "subclass=FRHoF;class=XPHB"); [Paladin](/3-Mechanics/CLI/lists/list-spells-classes-paladin.md)
