...
**At Higher Levels.** When you cast this spell using a spell slot of 3rd level or higher, increase the cold damage by `dice:1d8|noform|noparens|avg|text(1d8)` for each slot level above 2nd.
