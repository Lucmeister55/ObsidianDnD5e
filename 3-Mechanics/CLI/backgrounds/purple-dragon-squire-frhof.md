...
- **Skill Proficiencies.** [Animal Handling](/3-Mechanics/CLI/skills.md#Animal%20Handling) and [Insight](/3-Mechanics/CLI/skills.md#Insight)  
- **Tool Proficiencies.** [Navigator's Tools](/3-Mechanics/CLI/items/navigators-tools-xphb.md)  
- **Equipment.** Choose A or B: (A) [Spear](/3-Mechanics/CLI/items/spear-xphb.md), [Navigator's Tools](/3-Mechanics/CLI/items/navigators-tools-xphb.md), [Fine Clothes](/3-Mechanics/CLI/items/fine-clothes-xphb.md), 9 GP; or (B) 50 GP  
