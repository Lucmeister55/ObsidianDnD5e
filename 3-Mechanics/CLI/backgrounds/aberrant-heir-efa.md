...
![](/3-Mechanics/CLI/backgrounds/img/aberrant-heir.webp#right)

- **Ability Scores.** Strength, Constitution, Charisma  
- **Feat.** [Aberrant Dragonmark](/3-Mechanics/CLI/feats/aberrant-dragonmark-efa.md)  
- **Skill Proficiencies.** [History](/3-Mechanics/CLI/skills.md#History) and [Intimidation](/3-Mechanics/CLI/skills.md#Intimidation)  
- **Tool Proficiencies.** [Disguise Kit](/3-Mechanics/CLI/items/disguise-kit-xphb.md)  
- **Equipment.** Choose A or B: (A) [Dagger](/3-Mechanics/CLI/items/dagger-xphb.md), [Disguise Kit](/3-Mechanics/CLI/items/disguise-kit-xphb.md), [Costume](/3-Mechanics/CLI/items/costume-xphb.md), [Traveler's Clothes](/3-Mechanics/CLI/items/travelers-clothes-xphb.md), 16 GP; or (B) 50 GP  
