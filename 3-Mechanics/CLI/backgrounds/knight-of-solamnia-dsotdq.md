...
- **Equipment.** An insignia of rank, a [deck of cards](/3-Mechanics/CLI/items/playing-cards-xphb.md), a set of common clothes, and a [pouch](/3-Mechanics/CLI/items/pouch-xphb.md) containing 10 gp  
...
Any class that has martial prowess can be a good fit in the Knights of Solamnia. [Fighters](/3-Mechanics/CLI/classes/fighter-xphb.md) and [paladins](/3-Mechanics/CLI/classes/paladin-xphb.md) make up the bulk of the knighthood's forces. [Clerics](/3-Mechanics/CLI/classes/cleric-xphb.md) (often with the [War](/3-Mechanics/CLI/classes/cleric-xphb.md) domain) can also be found among the knights' ranks.

For a more unusual take on a Knight of Solamnia character, consider playing a bard of the [College of Valor](/3-Mechanics/CLI/classes/bard-xphb.md) (or the College of Swords from "Xanathar's Guide to Everything") or a [barbarian](/3-Mechanics/CLI/classes/barbarian-xphb.md) devoted to the ideals of the nature god Habbakuk (perhaps adopting the [Path of the Zealot](/3-Mechanics/CLI/classes/barbarian-xphb-path-of-the-zealot-xphb.md) from "Xanathar's Guide to Everything").

### Knight of Solamnia Trinkets

When you make your character, roll once on the Knight of Solamnia Trinkets table instead of on the [Trinkets table](/3-Mechanics/CLI/items/trinket-xphb.md) in the Player's Handbook for your starting trinket.
