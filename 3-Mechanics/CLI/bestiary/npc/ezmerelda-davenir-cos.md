...
- "Ezmerelda d'Avenir"
---
# [Ezmerelda d'Avenir](/3-Mechanics/CLI/bestiary/npc/ezmerelda-davenir-cos.md)
...
"skillsaves":
  ...
  - "name": "[Survival](/3-Mechanics/CLI/skills.md#Survival)"
    "desc": "+6"
"gear":
  - "[+1 handaxe](/3-Mechanics/CLI/items/1-weapon-xdmg.md)"
  - "[+1 rapier](/3-Mechanics/CLI/items/1-weapon-xdmg.md)"
  - "[silvered shortsword](/3-Mechanics/CLI/items/silvered-weapon-xdmg.md)"
