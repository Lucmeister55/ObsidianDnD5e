...
- "Kiril Stoyanovich"
---
# [Kiril Stoyanovich](/3-Mechanics/CLI/bestiary/npc/kiril-stoyanovich-cos.md)
...
"traits":
  - "desc": "Kiril can use its action to polymorph into a wolf-humanoid hybrid or\
    ...
    "name": "Shapechanger"
  - "desc": "Kiril has advantage on Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception))\
