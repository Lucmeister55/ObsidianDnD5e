...
"traits":
  ...
  - "desc": "Whenever the golem starts its turn [Bloodied](/3-Mechanics/CLI/conditions.md#Bloodied),\
      ...
      \ goes berserk, it remains so until it is destroyed or it is no longer [Bloodied](/3-Mechanics/CLI/conditions.md#Bloodied).\n\
      ...
      \ point it resumes rolling for the Berserk trait again if it is still [Bloodied](/3-Mechanics/CLI/conditions.md#Bloodied)."
    "name": "Berserk"
