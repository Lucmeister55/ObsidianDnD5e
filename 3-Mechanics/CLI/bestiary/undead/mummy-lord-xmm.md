...
"regional_effects":
  - "desc": "The region containing a mummy lord's lair is warped by its presence,\
      ...
      \ Action](/3-Mechanics/CLI/variant-rules/bonus-action-xphb.md), or [Reaction](/3-Mechanics/CLI/variant-rules/reaction-xphb.md)\
      ...
      \ on [Death Saving Throws](/3-Mechanics/CLI/variant-rules/death-saving-throw-xphb.md).\
...
"source":
  - "XMM"
"image": "file://D:\\ProgramData\\CLI\\5etools-img/bestiary/tokens/XMM/Mummy Lord.webp"
```
^statblock
