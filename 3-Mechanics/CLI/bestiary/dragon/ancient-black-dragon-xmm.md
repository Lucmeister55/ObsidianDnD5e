...
"regional_effects":
  - "desc": "The region containing an adult or ancient black dragon's lair is warped\
      ...
      \ area [Lightly Obscured](/3-Mechanics/CLI/variant-rules/lightly-obscured-xphb.md).\
...
"source":
  - "XMM"
"image": "file://D:\\ProgramData\\CLI\\5etools-img/bestiary/tokens/XMM/Ancient Black\
  \ Dragon.webp"
```
^statblock
