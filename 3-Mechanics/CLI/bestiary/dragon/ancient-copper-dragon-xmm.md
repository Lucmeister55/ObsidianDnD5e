...
"regional_effects":
  - "desc": "The region containing an adult or ancient copper dragon's lair is changed\
      ...
      \ on a [D20 Test](/3-Mechanics/CLI/variant-rules/d20-test-xphb.md), it must\
      \ succeed on a DC 15 Wisdom saving throw or have the [Incapacitated](/3-Mechanics/CLI/conditions.md#Incapacitated)\
...
"source":
  - "XMM"
"image": "file://D:\\ProgramData\\CLI\\5etools-img/bestiary/tokens/XMM/Ancient Copper\
  \ Dragon.webp"
```
^statblock
