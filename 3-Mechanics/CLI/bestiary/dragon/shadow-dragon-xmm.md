...
"bonus_actions":
  - "desc": "While in [Dim Light](/3-Mechanics/CLI/variant-rules/dim-light-xphb.md)\
      \ or [Darkness](/3-Mechanics/CLI/variant-rules/darkness-xphb.md), the dragon\
      \ takes the [Hide](/3-Mechanics/CLI/actions.md#Hide) action."
    "name": "Shadow Stealth"
"regional_effects":
  - "desc": "The region around a shadow dragon's lair is twisted by its presence,\
      \ creating the following effects:\n\n- **Negative Energy Suffusion.** Whenever\
      \ a creature within 1 mile of the lair regains [Hit Points](/3-Mechanics/CLI/variant-rules/hit-points-xphb.md)\
