...
Most dragons are proficient in the [Perception](/3-Mechanics/CLI/skills.md#Perception) and [Stealth](/3-Mechanics/CLI/skills.md#Stealth) skills, and many dragons have additional skill proficiencies. As with languages, you can customize a dragon's skill list (even doubling their proficiency bonus with certain skills) to reflect particular interests and activities. You can also give a dragon tool proficiencies, particularly if the dragon spends time in Humanoid form.
...
- **Special Senses.** Most dragons have [blindsight](/3-Mechanics/CLI/senses.md#Blindsight) and [darkvision](/3-Mechanics/CLI/senses.md#Darkvision). You might upgrade [blindsight](/3-Mechanics/CLI/senses.md#Blindsight) to [truesight](/3-Mechanics/CLI/senses.md#Truesight), or you could give a dragon with a burrowing speed [tremorsense](/3-Mechanics/CLI/senses.md#Tremorsense). (See the "introduction" to the "Monster Manual".)  
