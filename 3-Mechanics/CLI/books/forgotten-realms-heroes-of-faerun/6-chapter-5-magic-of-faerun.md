...
The most powerful and direct form of spellfire is spellfire sorcery. But characters of any class can display a connection to spellfire by taking the [Spellfire Spark](/3-Mechanics/CLI/feats/spellfire-spark-frhof.md) and [Spellfire Adept](/3-Mechanics/CLI/feats/spellfire-adept-frhof.md) feats. See "chapter 1" for more on these feats and the [Spellfire Sorcery](/3-Mechanics/CLI/classes/sorcerer-xphb-spellfire-sorcery-frhof.md) subclass.
...
> 
> **Detect Magic.** The [Detect Magic](/3-Mechanics/CLI/spells/detect-magic-xphb.md) spell reveals threads of the Weave woven together through spellcasting, and the way the threads are arranged reveals the school of magic. Similarly, active spells and areas imbued with magic are limned in a silvery network of threads, which might twist and reknit themselves depending on the magic involved. A magic item appears enmeshed in the silvery-blue threads of the Weave.
> 
> **Dispel Magic.** The [Dispel Magic](/3-Mechanics/CLI/spells/dispel-magic-xphb.md) spell unravels woven threads of the Weave.
> 
> **Antimagic.** The [Antimagic Field](/3-Mechanics/CLI/spells/antimagic-field-xphb.md) spell unravels magic woven from the Weave. While an otherwise-permanent effect is within an area of antimagic, the knots of the Weave untie, but the threads retie themselves once the magic is outside the antimagic effect.
> 
...
The rules for [dead magic](/3-Mechanics/CLI/traps-hazards/dead-magic-zone-xdmg.md) and [wild magic](/3-Mechanics/CLI/traps-hazards/wild-magic-zone-xdmg.md) zones are in chapter 3 of the "Dungeon Master's Guide".
...
You take a [Magic](/3-Mechanics/CLI/actions.md#Magic) action to initiate casting a Circle spell. When you do so, choose which Circle casting option (see "Circle Casting Options" below) you're using for this casting; you must also meet any of the other requirements described in that option's text. Until the Circle spell's casting is complete (see below), you must maintain [Concentration](/3-Mechanics/CLI/conditions.md#Concentration) on the spell.

If a Reaction would trigger when a creature casts a spell—such as the Reaction taken to cast [Counterspell](/3-Mechanics/CLI/spells/counterspell-xphb.md)—it also triggers when you take this action to initiate a Circle spell.
...
After you initiate the spell, each secondary caster takes the [Magic](/3-Mechanics/CLI/actions.md#Magic) action to contribute to the spell. A secondary caster can take this action only while within 30 feet of you and before the start of your next turn.
...
If the spell has a casting time of 1 minute or more, you and each secondary caster must take the [Magic](/3-Mechanics/CLI/actions.md#Magic) action on each of your turns for the entire casting time, and you must each maintain Concentration while you do so. In this case, if any caster's Concentration is broken, the spell fails.
...
When you cast a spell that requires [Concentration](/3-Mechanics/CLI/conditions.md#Concentration), you can distribute the mental load of the spell among you and the secondary casters. Once the casting is complete, you and all secondary casters can maintain Concentration on this spell. As long as at least one caster who contributed to the spell maintains this Concentration, the spell's effects remain active.

#### Expand

When you cast a spell that creates an area of effect, you can increase one dimension of the spell's area of effect for this casting by 10 feet per secondary caster contributing to the spell. For example, if a spell creates a 20-foot-radius [Sphere](/3-Mechanics/CLI/variant-rules/sphere-area-of-effect-xphb.md), casting it as a Circle spell with two secondary casters would increase the radius to 40 feet. A spell that creates a [Line](/3-Mechanics/CLI/variant-rules/line-area-of-effect-xphb.md) that is 5 feet wide and 300 feet long, cast as a Circle spell with two secondary casters, could make a Line that is either 25 feet wide or 320 feet long.
...
![Prolong](/3-Mechanics/CLI/tables/prolong-frhof.md)

#### Safeguard

When you cast a spell that creates an area of effect, you can carve out a safe zone within that area of effect that is unaffected by the spell for its duration. This safe zone consists of a number of 5-foot [Cubes](/3-Mechanics/CLI/variant-rules/cube-area-of-effect-xphb.md) equal to your spellcasting ability modifier plus the number of secondary casters contributing to the spell (minimum of one Cube). You can arrange the Cubes as you like, but each Cube must be contiguous with at least one other Cube.

If the spell's area of effect can be moved, the safe zone moves with it.

#### Supplant

When you cast a spell that requires at least one Material component with a specified cost that is consumed by the spell, you can reduce the minimum cost of one such Material component by 50 GP per each secondary caster contributing to the spell. For example, casting [Revivify](/3-Mechanics/CLI/spells/revivify-xphb.md) as a Circle spell with two secondary casters would reduce the Material component's minimum cost to 200 GP.
...
- [Alustriel's Mooncloak](/3-Mechanics/CLI/spells/alustriels-mooncloak-frhof.md)  
- [Backlash](/3-Mechanics/CLI/spells/backlash-frhof.md)  
- [Blade of Disaster](/3-Mechanics/CLI/spells/blade-of-disaster-frhof.md)  
- [Cacophonic Shield](/3-Mechanics/CLI/spells/cacophonic-shield-frhof.md)  
- [Conjure Constructs](/3-Mechanics/CLI/spells/conjure-constructs-frhof.md)  
- [Death Armor](/3-Mechanics/CLI/spells/death-armor-frhof.md)  
- [Deryan's Helpful Homunculi](/3-Mechanics/CLI/spells/deryans-helpful-homunculi-frhof.md)  
- [Dirge](/3-Mechanics/CLI/spells/dirge-frhof.md)  
- [Doomtide](/3-Mechanics/CLI/spells/doomtide-frhof.md)  
- [Elminster's Effulgent Spheres](/3-Mechanics/CLI/spells/elminsters-effulgent-spheres-frhof.md)  
- [Elminster's Elusion](/3-Mechanics/CLI/spells/elminsters-elusion-frhof.md)  
- [Holy Star of Mystra](/3-Mechanics/CLI/spells/holy-star-of-mystra-frhof.md)  
- [Laeral's Silver Lance](/3-Mechanics/CLI/spells/laerals-silver-lance-frhof.md)  
- [Simbul's Synostodweomer](/3-Mechanics/CLI/spells/simbuls-synostodweomer-frhof.md)  
- [Songal's Elemental Suffusion](/3-Mechanics/CLI/spells/songals-elemental-suffusion-frhof.md)  
- [Spellfire Flare](/3-Mechanics/CLI/spells/spellfire-flare-frhof.md)  
- [Spellfire Storm](/3-Mechanics/CLI/spells/spellfire-storm-frhof.md)  
- [Syluné's Viper](/3-Mechanics/CLI/spells/sylunes-viper-frhof.md)  
- [Wardaway](/3-Mechanics/CLI/spells/wardaway-frhof.md)