...
> [!readaloud] 
> 
> Welcome to Aurora's Whole Realms Catalog!
> 
...
> 
> What you see here is just a sample of the hundreds of items on sale at any of our emporium shops, located in towns and cities in every realm. If you don't see what you want at one of our shops, our special orders are swift and reliable and come with a satisfaction guarantee. We even deliver!
^2ca

## Equipment

The following equipment can be purchased through *Aurora's Whole Realms Catalog*.

### Adventuring Gear

This section describes adventuring gear used throughout the Realms.

![Adventuring Gear](/3-Mechanics/CLI/tables/adventuring-gear-frhof.md)

## Mechanical Wonders

Calishites rely on the technological marvels known as Mechanical Wonders.

![Mechanical Wonders](/3-Mechanics/CLI/tables/mechanical-wonders-frhof.md)

## Mounts and Other Animals

People in Faerûn use animals for transportation and other tasks.

![Mounts and Other Animals](/3-Mechanics/CLI/tables/mounts-and-other-animals-frhof.md)

## Tools

The Musical Instruments described here are used by musicians across Faerûn.

![Tools](/3-Mechanics/CLI/tables/tools-frhof.md)

## Travel

Travelers in the Realms might use interesting modes of transport.

![Travel](/3-Mechanics/CLI/tables/travel-frhof.md)
...
Each of Cottle's black coaches is a Carriage (see the "Player's Handbook") keyed to a unique sigil sequence. While inside a black coach, a creature can take a [Magic](/3-Mechanics/CLI/actions.md#Magic) action to turn a combination dial and input a sigil sequence belonging to another black coach. All creatures inside the coach then teleport to that destination coach. If the destination coach is occupied, the teleport fails and the action is wasted.
...
![Vehicles](/3-Mechanics/CLI/tables/vehicles-frhof.md)