...
![Conflict between houses es...](/3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/066-07-001-airship-battle.webp#center "Conflict between houses escalates to the skies as elemental airships join in battle")
...
The pilot (the crew member operating an airship's Helm) must have the [Mark of Storm](/3-Mechanics/CLI/feats/mark-of-storm-efa.md) to interface with the controls. While operating the Helm, a crew member can take the station's Drive and Shift Engine actions.
...
After 1 hour of work, the creature makes a DC 16 Dexterity ([Sleight of Hand](/3-Mechanics/CLI/skills.md#Sleight%20of%20Hand)) or Intelligence ([Arcana](/3-Mechanics/CLI/skills.md#Arcana)) check using [Carpenter's Tools](/3-Mechanics/CLI/items/carpenters-tools-xphb.md), [Smith's Tools](/3-Mechanics/CLI/items/smiths-tools-xphb.md), or [Tinker's Tools](/3-Mechanics/CLI/items/tinkers-tools-xphb.md). On a successful check, the airship or crew station regains `dice:2d4+2|noform|noparens|avg` (`2d4 + 2`) Hit Points and the parts are consumed. If the check fails, the repair can be attempted again using the same replacement parts.
...
An airship's elemental core and connecting arcane matrix are magical effects. If a section of an airship enters an area of antimagic, such as that produced by the [Antimagic Field](/3-Mechanics/CLI/spells/antimagic-field-xphb.md) spell, the weapons and other services in that section of the ship are inoperable.

If the ship's elemental core enters an area of antimagic, the elemental core is automatically suppressed and can't be reengaged until the core leaves the area of antimagic. If the elemental core is the target of the [Dispel Magic](/3-Mechanics/CLI/spells/dispel-magic-xphb.md) spell, the core is suppressed for 1 minute and can't be reengaged for the duration.
...
While the wind wards are active, creatures aboard the airship can breathe normally and the deck is free from winds. In addition, creatures on the ship have Advantage on saving throws to avoid being pushed off the deck of the ship, as the wind wards provide a buffer. If the elemental core is suppressed or destroyed, creatures aboard the airship might suffer the effects of [high altitude](/3-Mechanics/CLI/traps-hazards/high-altitude-xdmg.md) and [strong wind](/3-Mechanics/CLI/traps-hazards/strong-wind-xdmg.md) (see the "Dungeon Master's Guide").

## Airships in Combat

![](/3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/067-07-002-airship-getaway.webp#center)
...
A ship that has enough movement can pull alongside another vessel, deploy a boarding party, and then move away, provided the members of the boarding party took the [Ready](/3-Mechanics/CLI/actions.md#Ready) action and positioned themselves so they can move onto the other vessel once it's close enough.
...
Some players enjoy the challenge of having new things to do in combat, while others prefer to stick with the familiar options their characters bring to any fight. As DM, learn your players' preferences and try to build encounters that allow players to do what they most enjoy. A Fighter character whose player has no interest in using the ship's armaments might relish the opportunity to repel boarders, while a Wizard could delight in hurling [Fireball](/3-Mechanics/CLI/spells/fireball-xphb.md) spells at an enemy airship. Dragonmarked characters might particularly enjoy crew stations that allow their dragonmarks to shine.

> [!note] Vehicle Statistics
> 
> The descriptions of airships in this chapter present the same types of information that appears on the [Airborne and Waterborne Vehicles table](/3-Mechanics/CLI/tables/large-vehicles-airborne-and-waterborne-vehicles-xphb.md) in the "Player's Handbook". Refer to that book for details.
> 
...
- [Lyrandar Air Cruiser](/3-Mechanics/CLI/vehicles/lyrandar-air-cruiser-efa.md)  
- [Lyrandar Skyskiff](/3-Mechanics/CLI/vehicles/lyrandar-skyskiff-efa.md)  
- [Strider Airship](/3-Mechanics/CLI/vehicles/strider-airship-efa.md)  
...
A creature occupying this station has [Three-Quarters Cover](/3-Mechanics/CLI/tables/cover-xphb.md) against attacks and other effects that originate outside it. While inside this station, a crew member can take the Boost action. The ship can benefit from only one increase to Fly Speed from an Elemental Thrusters station at a time.

##### Mark of Passage

If a creature with the [Mark of Passage](/3-Mechanics/CLI/feats/mark-of-passage-efa.md) takes the Boost action, the ship's Fly Speed increases by 100 feet instead.
...
A creature inside the Repair Clamps station has [Half Cover](/3-Mechanics/CLI/tables/cover-xphb.md). A crew member operating an airship's Repair Clamps requires the [Mark of Making](/3-Mechanics/CLI/feats/mark-of-making-efa.md) to interface with the controls. While operating the Repair Clamps, a crew member can take the Quick Repair action.
...
The ship has the [Invisible](/3-Mechanics/CLI/conditions.md#Invisible) condition, and while on board it, creatures are also [Invisible](/3-Mechanics/CLI/conditions.md#Invisible). These effects last for 1 hour, until this station is destroyed, or until the crew member that took this action loses Concentration or leaves this station.
...
If a creature with the [Mark of Shadow](/3-Mechanics/CLI/feats/mark-of-shadow-efa.md) occupies this crew station, that creature can take the Cloak action as a Bonus Action.
...
![Encounter Distance; Airship Travel Conditions](/3-Mechanics/CLI/tables/encounter-distance-airship-travel-conditions-efa.md)
...
**250 feet** is long range for a [Ballista](/3-Mechanics/CLI/objects/ballista-xdmg.md) and most Ranged weapons and beyond the range of most spells.

**500 feet** is long range for a [Mangonel](/3-Mechanics/CLI/objects/mangonel-xdmg.md) or a [Longbow](/3-Mechanics/CLI/items/longbow-xphb.md) and beyond the range of most Ranged weapons.

**1,000 feet** is long range for a [Cannon](/3-Mechanics/CLI/objects/cannon-xdmg.md) and beyond the range of most siege equipment and crew stations.
...
> ![Airborne Encounters](/3-Mechanics/CLI/tables/airborne-encounters-efa.md)
...
When an airship is at risk of getting lost—such as when traveling through dense fog or over unfamiliar land—the crew member operating the ship's Helm makes a Wisdom ([Survival](/3-Mechanics/CLI/skills.md#Survival)) check; the DC for this check is determined by the Airship Travel Conditions table. Another crew member who has proficiency in the [Survival](/3-Mechanics/CLI/skills.md#Survival) skill can take the [Help](/3-Mechanics/CLI/actions.md#Help) action to assist this check as normal.
...
![Weather Hazards; Environmental Hazards](/3-Mechanics/CLI/tables/weather-hazards-environmental-hazards-efa.md)

#### Searches

As with a journey on the ground, sometimes characters spend part of their journey searching for something—usually something on the ground. When characters are searching the ground from the air, use the Search DC for the terrain on the ground from the [Travel Terrain table](/3-Mechanics/CLI/tables/travel-terrain-xdmg.md) in the "Dungeon Master's Guide", but feel free to give characters Advantage on Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) checks if their aerial vantage point makes it easier for them to see what they're looking for.