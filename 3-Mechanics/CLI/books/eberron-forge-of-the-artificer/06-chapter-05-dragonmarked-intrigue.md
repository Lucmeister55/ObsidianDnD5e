...
![Members of different drago...](/3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/042-05-001-members-of-dragonmarked-houses.webp#center "Members of different dragonmarked houses set aside their differences to investigate a murder in Sharn, the City of Towers.")
...
- **House Agent.** The [House Agent](/3-Mechanics/CLI/backgrounds/house-agent-efa.md) background grants a starting Renown Score of 3 with a character's house.  
- **House Heir.** A house heir background (such as [House Cannith Heir](/3-Mechanics/CLI/backgrounds/house-cannith-heir-efa.md)) grants a starting Renown Score of 5 with a character's house.  
- **Dragonmark Feat.** Acquiring a Dragonmark feat (except the [Aberrant Dragonmark](/3-Mechanics/CLI/feats/aberrant-dragonmark-efa.md) feat) after level 1 increases a character's Renown Score with the associated house by 1.  
- **Greater Dragonmark.** Acquiring the greater dragonmark feat associated with a house (such as [Greater Mark of Making](/3-Mechanics/CLI/feats/greater-mark-of-making-efa.md)) increases a character's Renown Score with that house by 2.  
- **Siberys Dragonmark.** Acquiring the [Boon of Siberys](/3-Mechanics/CLI/feats/boon-of-siberys-efa.md) feat, or another feat in the Epic Boon category that represents a Siberys dragonmark, increases a character's Renown Score with the associated house by 3.  
...
- [Favored in House](/3-Mechanics/CLI/optional-features/favored-in-house-efa.md)  
- [Recognized in House](/3-Mechanics/CLI/optional-features/recognized-in-house-efa.md)  
- [Celebrated in House](/3-Mechanics/CLI/optional-features/celebrated-in-house-efa.md)  
- [Preeminent in House](/3-Mechanics/CLI/optional-features/preeminent-in-house-efa.md)  
...
![Building a Party; Party Makeup](/3-Mechanics/CLI/tables/building-a-party-party-makeup-efa.md)
...
![](/3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/043-05-002-members-of-dragonmarked-houses-in-conflict.webp#center)
...
![A Tarkanan Marauder and a Tarkanan Ruffian](/3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/044-05-003-tarkanan-marauder-and-ruffian.webp#center)
...
The Son of Khyber leads a small army of aberrant-marked warriors and assassins to challenge the leadership of Sharn—and plots to conjure a [Blob of Annihilation](/3-Mechanics/CLI/bestiary/ooze/blob-of-annihilation-xmm.md) to level the city's skyscraping towers.

#### Aberrant Heirs

House Tarkanan incorporates members with a wide variety of aberrant dragonmarks. Any Humanoid in the "Monster Manual" or another source could be a House Tarkanan agent with a mark that doesn't affect the creature's use in combat or that is reflected in the creature's existing abilities. For example, a [Vampire Familiar](/3-Mechanics/CLI/bestiary/humanoid/vampire-familiar-xmm.md) might gain its unique abilities from an aberrant mark rather than from any connection to a vampire, and a [Bandit Deceiver](/3-Mechanics/CLI/bestiary/humanoid/bandit-deceiver-xmm.md)'s spellcasting could derive from such a mark. On the other hand, an ordinary [Bandit](/3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) or [Tough](/3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) might have an aberrant mark that allows the NPC to cast [Disguise Self](/3-Mechanics/CLI/spells/disguise-self-xphb.md), [Silent Image](/3-Mechanics/CLI/spells/silent-image-xphb.md), or a similar spell with little impact on the NPC's combat abilities.

The two stat blocks presented here, along with the Tarkanan Assassin in "Eberron: Rising from the Last War", illustrate members of House Tarkanan who wield the power of their aberrant marks in combat.
...
> ![Tarkanan Marauder](/3-Mechanics/CLI/bestiary/humanoid/tarkanan-marauder-efa.md#^statblock)
...
> ![Tarkanan Ruffian](/3-Mechanics/CLI/bestiary/humanoid/tarkanan-ruffian-efa.md#^statblock)
...
![Agents of (Left to Right) ...](/3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/045-05-004-agents-of-the-houses.webp#center "Agents of (Left to Right) House Deneith, House Ghallanda, House Lyrandar, House Cannith, House Jorasco, and House Kundarak")

### House Cannith

![](/3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/046-05-006-house-cannith.webp#center)
...
![](/3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/047-05-013-house-deneith.webp#center)
...
You can request the assistance of `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) mercenaries for up to 1 day. The mercenaries are Medium [Guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md).
...
![](/3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/048-05-007-house-ghallanda.webp#center)
...
![](/3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/049-05-008-house-jorasco.webp#center)
...
You can purchase one [Potion of Healing](/3-Mechanics/CLI/items/potion-of-healing-xdmg.md) (any variety) at half the usual cost.
...
![](/3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/050-05-009-house-kundarak.webp#center)
...
![](/3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/051-05-010-house-lyrandar.webp#center)
...
![Agents of (Left to Right) ...](/3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/052-05-005-more-agents-of-the-houses.webp#center "Agents of (Left to Right) House Medani, House Orien, House Tharashk, House Phiarlan, House Vadalis, and House Sivis")

### House Medani

![](/3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/053-05-011-house-medani.webp#center)
...
![](/3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/054-05-012-house-orien.webp#center)
...
![](/3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/055-05-014-house-phiarlan.webp#center)
...
![](/3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/056-05-016-house-sivis.webp#center)
...
![](/3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/057-05-017-house-tharashk.webp#center)
...
You can purchase a dragonshard, or one Common or Uncommon magic item that incorporates dragonshards, at half the usual cost. Alternatively, you can request the assistance of a mercenary from Droaam (a [Harpy](/3-Mechanics/CLI/bestiary/monstrosity/harpy-xmm.md), an [Ogrillon Ogre](/3-Mechanics/CLI/bestiary/giant/ogrillon-ogre-xmm.md), a [Spy](/3-Mechanics/CLI/bestiary/humanoid/spy-xmm.md), or a [Thri-kreen Marauder](/3-Mechanics/CLI/bestiary/monstrosity/thri-kreen-marauder-xmm.md)) for up to 1 day.
...
![](/3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/058-05-015-house-thuranni.webp#center)
...
![](/3-Mechanics/CLI/books/eberron-forge-of-the-artificer/img/059-05-018-house-vadalis.webp#center)
...
![Dragonmarked Intrigue Adventures; House Intrigue](/3-Mechanics/CLI/tables/dragonmarked-intrigue-adventures-house-intrigue-efa.md)
...
> ![Cannith Artificer](/3-Mechanics/CLI/bestiary/humanoid/cannith-artificer-efa.md#^statblock)
...
> ![Ghallanda Troubleshooter](/3-Mechanics/CLI/bestiary/humanoid/ghallanda-troubleshooter-efa.md#^statblock)
...
> ![Jorasco Medic](/3-Mechanics/CLI/bestiary/humanoid/jorasco-medic-efa.md#^statblock)
...
> ![Kundarak Warden](/3-Mechanics/CLI/bestiary/humanoid/kundarak-warden-efa.md#^statblock)
...
> ![Lyrandar Scion](/3-Mechanics/CLI/bestiary/humanoid/lyrandar-scion-efa.md#^statblock)
...
> ![Medani Inquisitive](/3-Mechanics/CLI/bestiary/humanoid/medani-inquisitive-efa.md#^statblock)
...
> ![Orien Enforcer](/3-Mechanics/CLI/bestiary/humanoid/orien-enforcer-efa.md#^statblock)
...
> ![Sentinel Marshal](/3-Mechanics/CLI/bestiary/humanoid/sentinel-marshal-efa.md#^statblock)
...
> ![Shadow-Marked Agent](/3-Mechanics/CLI/bestiary/humanoid/shadow-marked-agent-efa.md#^statblock)
...
> ![Sivis Scribe](/3-Mechanics/CLI/bestiary/humanoid/sivis-scribe-efa.md#^statblock)
...
Tharashk hunters, typically humans or orcs, often work alongside [Druids](/3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md) of the Gatekeepers, and occasionally with [Aberrant Cultists](/3-Mechanics/CLI/bestiary/humanoid/aberrant-cultist-xmm.md) of the Dragon Below.

> [!embed-monster]- Tharashk Hunter
> ![Tharashk Hunter](/3-Mechanics/CLI/bestiary/humanoid/tharashk-hunter-efa.md#^statblock)

#### Vadalis Heir

Combining druidic magic with skill at handling natural and monstrous animals, the dragonmarked heirs of House Vadalis, most of whom are human, are more fearsome than their innocuous-seeming house suggests—especially when accompanied by a [Giant Boar](/3-Mechanics/CLI/bestiary/beast/giant-boar-xmm.md), [Polar Bear](/3-Mechanics/CLI/bestiary/beast/polar-bear-xmm.md), or [Rhinoceros](/3-Mechanics/CLI/bestiary/beast/rhinoceros-xmm.md).

> [!embed-monster]- Vadalis Heir
> ![Vadalis Heir](/3-Mechanics/CLI/bestiary/humanoid/vadalis-heir-efa.md#^statblock)