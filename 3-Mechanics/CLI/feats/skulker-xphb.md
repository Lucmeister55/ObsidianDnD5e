...
**Fog of War.** You exploit the distractions of battle, gaining [Advantage](/3-Mechanics/CLI/variant-rules/advantage-xphb.md) on any Dexterity ([Stealth](/3-Mechanics/CLI/skills.md#Stealth)) check you make as part of the [Hide](/3-Mechanics/CLI/actions.md#Hide) action during combat.
