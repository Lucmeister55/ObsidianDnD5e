...
**Halt.** When you hit a creature with an [Opportunity Attack](/3-Mechanics/CLI/actions.md#Opportunity%20Attack), the creature's [Speed](/3-Mechanics/CLI/variant-rules/speed-xphb.md) becomes 0 for the rest of the current turn.