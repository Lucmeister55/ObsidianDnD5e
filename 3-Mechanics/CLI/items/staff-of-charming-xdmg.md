...
![](file://D:\ProgramData\CLI\5etools-img/items/XDMG/Staff of Charming.webp#right)
...
The staff regains `dice:1d8+2|noform|noparens|avg` (`1d8 + 2`) expended charges daily at dawn. If you expend the last charge, roll `dice:1d20|noform|noparens|avg` (`1d20`). On a 1, the staff crumbles to dust and is destroyed.
