...
![](file://D:\ProgramData\CLI\5etools-img/items/XDMG/Staff of Frost.webp#right)
...
The staff regains `dice:1d6+4|noform|noparens|avg` (`1d6 + 4`) expended charges daily at dawn. If you expend the last charge, roll `dice:1d20|noform|noparens|avg` (`1d20`). On a 1, the staff turns to water and is destroyed.
