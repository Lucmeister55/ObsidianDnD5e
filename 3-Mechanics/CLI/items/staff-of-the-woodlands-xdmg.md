...
The staff regains `dice:1d6|noform|noparens|avg` (`1d6`) expended charges daily at dawn. If you expend the last charge, roll `dice:1d20|noform|noparens|avg` (`1d20`). On a 1, the staff loses its properties and becomes a nonmagical Quarterstaff.
