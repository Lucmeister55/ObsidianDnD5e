...
The wand regains `dice:1d6+1|noform|noparens|avg` (`1d6 + 1`) expended charges daily at dawn. If you expend the wand's last charge, roll `dice:1d20|noform|noparens|avg` (`1d20`). On a 1, the wand crumbles into dust and is destroyed.

![Wand of Wonder Effects](/3-Mechanics/CLI/tables/wand-of-wonder-effects-xdmg.md)
