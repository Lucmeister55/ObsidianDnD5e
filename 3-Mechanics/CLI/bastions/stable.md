...
After a Beast that can serve as a mount spends at least 14 days in this facility, all Wisdom ([Animal Handling](/3-Mechanics/CLI/skills.md#Animal%20Handling)) checks made with respect to it have [Advantage](/3-Mechanics/CLI/variant-rules/advantage-xphb.md).
