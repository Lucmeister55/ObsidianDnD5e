...
The Workshop comes equipped with six different kinds of [Artisan's Tools](/3-Mechanics/CLI/items/artisans-tools-xphb.md), chosen from the following list:
...
After spending an entire [Short Rest](/3-Mechanics/CLI/variant-rules/short-rest-xphb.md) in your Workshop, you gain [Heroic Inspiration](/3-Mechanics/CLI/variant-rules/heroic-inspiration-xphb.md). You can't gain this benefit again until you finish a [Long Rest](/3-Mechanics/CLI/variant-rules/long-rest-xphb.md).

## Enlarging the Facility

You can enlarge your Workshop to a Vast facility by spending 2,000 GP. If you do so, the Workshop gains two additional hirelings and three additional [Artisan's Tools](/3-Mechanics/CLI/items/artisans-tools-xphb.md) (chosen from the list above).
