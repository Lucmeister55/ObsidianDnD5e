...
|--------------|----------------|
| Battle Expert | When you take damage from an attack made with an [Unarmed Strike](/3-Mechanics/CLI/variant-rules/unarmed-strike-xphb.md) or a weapon, you can take a [Reaction](/3-Mechanics/CLI/variant-rules/reaction-xphb.md) to reduce this damage by `dice:1d4\|noform\|noparens\|avg` (`1d4`). |
