...
Companions of the Ruby Rose are trained in battle, presentation, and poise. Companions receive a free Comfortable lifestyle when staying at holdings of Sune's faithful. When need arises, Companions can requisition the aid of a [Mage](/3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md) or [Priest](/3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md) of Sune.
