...
**Charismatic.** You are blessed with an otherworldly presence and have [Advantage](/3-Mechanics/CLI/variant-rules/advantage-xphb.md) on all Charisma checks.

**Saving Throw Reroll.** If you fail a saving throw, you can take a [Reaction](/3-Mechanics/CLI/variant-rules/reaction-xphb.md) to reroll it. You must use this new roll.
