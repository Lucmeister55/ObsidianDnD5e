...
**Challenge Rating.** The maximum [Challenge Rating](/3-Mechanics/CLI/variant-rules/challenge-rating-xphb.md) for the form equals your Druid level divided by 3 (round down).
...
**Temporary Hit Points.** You gain a number of [Temporary Hit Points](/3-Mechanics/CLI/variant-rules/temporary-hit-points-xphb.md) equal to three times your Druid level.
...
**Improved Lunar Radiance.** Once per turn, you can deal an extra `dice:2d10|noform|noparens|avg` (`2d10`) Radiant damage to a target you hit with a Wild Shape form's attack.
