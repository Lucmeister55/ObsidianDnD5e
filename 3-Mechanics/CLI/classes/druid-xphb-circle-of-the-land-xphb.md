...
You are immune to the [Poisoned](/3-Mechanics/CLI/conditions.md#Poisoned) condition, and you have [Resistance](/3-Mechanics/CLI/variant-rules/resistance-xphb.md) to a damage type associated with your current land choice in the Circle Spells feature, as shown in the Nature's Ward table.
...
As a [Magic](/3-Mechanics/CLI/actions.md#Magic) action, you can expend a use of your Wild Shape and cause spectral trees and vines to appear in a 15-foot [Cube](/3-Mechanics/CLI/variant-rules/cube-area-of-effect-xphb.md) on the ground within 120 feet of yourself. They last there for 1 minute or until you have the [Incapacitated](/3-Mechanics/CLI/conditions.md#Incapacitated) condition or die. You and your allies have [Half Cover](/3-Mechanics/CLI/variant-rules/cover-xphb.md) while in that area, and your allies gain the current [Resistance](/3-Mechanics/CLI/variant-rules/resistance-xphb.md) of your Nature's Ward while there.
