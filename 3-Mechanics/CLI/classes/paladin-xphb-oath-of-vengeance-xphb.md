...
**Flight.** You sprout spectral wings on your back, have a [Fly Speed](/3-Mechanics/CLI/variant-rules/fly-speed-xphb.md) of 60 feet, and can hover.

**Frightful Aura.** Whenever an enemy starts its turn in your Aura of Protection, that creature must succeed on a Wisdom saving throw or have the [Frightened](/3-Mechanics/CLI/conditions.md#Frightened) condition for 1 minute or until it takes any damage. [Attack](/3-Mechanics/CLI/actions.md#Attack) rolls against the [Frightened](/3-Mechanics/CLI/conditions.md#Frightened) creature have [Advantage](/3-Mechanics/CLI/variant-rules/advantage-xphb.md).