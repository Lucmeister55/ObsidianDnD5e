...
**Spell Slots.** The Arcane Trickster Spellcasting table shows how many spell slots you have to cast your level 1+ spells. You regain all expended spell slots when you finish a [Long Rest](/3-Mechanics/CLI/variant-rules/long-rest-xphb.md).

**Prepared Spells of 1st+ Level.** You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose three level 1 Wizard spells. [Charm Person](/3-Mechanics/CLI/spells/charm-person-xphb.md), [Disguise Self](/3-Mechanics/CLI/spells/disguise-self-xphb.md), and [Fog Cloud](/3-Mechanics/CLI/spells/fog-cloud-xphb.md) are recommended.
...
**Spellcasting Focus.** You can use an [Arcane Focus](/3-Mechanics/CLI/items/arcane-focus-xphb.md) as a [Spellcasting Focus](/3-Mechanics/CLI/variant-rules/spellcasting-focus-xphb.md) for your Wizard spells.
