...
|----------------|-----------------|----------------|---------------------|
| 1st | [shield](/3-Mechanics/CLI/spells/shield-xphb.md) | [ray of sickness](/3-Mechanics/CLI/spells/ray-of-sickness-xphb.md) | [color spray](/3-Mechanics/CLI/spells/color-spray-xphb.md) |
| 3rd | [lesser restoration](/3-Mechanics/CLI/spells/lesser-restoration-xphb.md) | [blindness/deafness](/3-Mechanics/CLI/spells/blindness-deafness-xphb.md) | [alter self](/3-Mechanics/CLI/spells/alter-self-xphb.md) |
| 5th | [dispel magic](/3-Mechanics/CLI/spells/dispel-magic-xphb.md) | [vampiric touch](/3-Mechanics/CLI/spells/vampiric-touch-xphb.md) | [phantom steed](/3-Mechanics/CLI/spells/phantom-steed-xphb.md) |
| 7th | [death ward](/3-Mechanics/CLI/spells/death-ward-xphb.md) | [confusion](/3-Mechanics/CLI/spells/confusion-xphb.md) | [hallucinatory terrain](/3-Mechanics/CLI/spells/hallucinatory-terrain-xphb.md) |
| 9th | [Rary's telepathic bond](/3-Mechanics/CLI/spells/rarys-telepathic-bond-xphb.md) | [hold monster](/3-Mechanics/CLI/spells/hold-monster-xphb.md) | [mislead](/3-Mechanics/CLI/spells/mislead-xphb.md) |
^lunar-spells
...
You can call down the radiant light of the moon on command. You learn the [sacred flame](/3-Mechanics/CLI/spells/sacred-flame-xphb.md) spell, which doesn't count against the number of sorcerer cantrips you know. When you cast the spell, you can target one creature as normal or target two creatures within range that are within 5 feet of each other.
...
- **Full Moon.** You can use a bonus action to shed bright light in a 10-foot radius and dim light for an additional 10 feet or to douse the light. In addition, you and creatures of your choice have advantage on Intelligence ([Investigation](/3-Mechanics/CLI/skills.md#Investigation)) and Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) checks while within the bright light you shed.  
- **New Moon.** You have advantage on Dexterity ([Stealth](/3-Mechanics/CLI/skills.md#Stealth)) checks. In addition, while you are entirely in darkness, attack rolls have disadvantage against you.  
