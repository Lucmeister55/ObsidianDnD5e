...
**Sleight of Hand.** Make a Dexterity ([Sleight of Hand](/3-Mechanics/CLI/skills.md#Sleight%20of%20Hand)) check to pick a lock or disarm a trap with [Thieves' Tools](/3-Mechanics/CLI/items/thieves-tools-xphb.md) or to pick a pocket.

**Use an Object.** Take the [Utilize](/3-Mechanics/CLI/actions.md#Utilize) action, or take the [Magic](/3-Mechanics/CLI/actions.md#Magic) action to use a magic item that requires that action.

### Second-Story Work (Level 3)

You've trained to get into especially hard-to-reach places, granting you these benefits.

**Climber.** You gain a [Climb Speed](/3-Mechanics/CLI/variant-rules/climb-speed-xphb.md) equal to your [Speed](/3-Mechanics/CLI/variant-rules/speed-xphb.md).
...
**Stealth Attack (Cost 1d6).** If you have the [Hide](/3-Mechanics/CLI/actions.md#Hide) action's [Invisible](/3-Mechanics/CLI/conditions.md#Invisible) condition, this attack doesn't end that condition on you if you end the turn behind [Three-Quarters Cover](/3-Mechanics/CLI/variant-rules/cover-xphb.md) or [Total Cover](/3-Mechanics/CLI/variant-rules/cover-xphb.md).
...
**Charges.** Whenever you use a magic item property that expends charges, roll `dice:1d6|noform|noparens|avg` (`1d6`). On a roll of 6, you use the property without expending the charges.
