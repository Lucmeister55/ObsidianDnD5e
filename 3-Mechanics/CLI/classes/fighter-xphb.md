...
When you reach certain Fighter levels, you gain the ability to use the [mastery properties](/3-Mechanics/CLI/variant-rules/weapon-mastery-properties-xphb.md) of more kinds of weapons, as shown in the Weapon Mastery column of the Fighter Features table.
