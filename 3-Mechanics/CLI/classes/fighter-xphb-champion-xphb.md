...
**Defy Death.** You have [Advantage](/3-Mechanics/CLI/variant-rules/advantage-xphb.md) on [Death Saving Throws](/3-Mechanics/CLI/variant-rules/death-saving-throw-xphb.md). Moreover, when you roll 18–20 on a [Death Saving Throw](/3-Mechanics/CLI/variant-rules/death-saving-throw-xphb.md), you gain the benefit of rolling a 20 on it.

**Heroic Rally.** At the start of each of your turns, you regain [Hit Points](/3-Mechanics/CLI/variant-rules/hit-points-xphb.md) equal to 5 plus your Constitution modifier if you are [Bloodied](/3-Mechanics/CLI/conditions.md#Bloodied) and have at least 1 [Hit Point](/3-Mechanics/CLI/variant-rules/hit-points-xphb.md).