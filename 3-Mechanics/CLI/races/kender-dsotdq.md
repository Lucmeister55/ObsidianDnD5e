...
![](file://D:\ProgramData\CLI\5etools-img/races/DSotDQ/Kender.webp#right)
...
You have advantage on saving throws you make to avoid or end the [frightened](/3-Mechanics/CLI/conditions.md#Frightened) condition on yourself. When you fail a saving throw to avoid or end the [frightened](/3-Mechanics/CLI/conditions.md#Frightened) condition on yourself, you can choose to succeed instead. Once you succeed on a saving throw in this way, you can't do so again until you finish a long rest.

### Kender Curiosity

Thanks to the mystical origin of your people, you gain proficiency with one of the following skills of your choice: [Insight](/3-Mechanics/CLI/skills.md#Insight), [Investigation](/3-Mechanics/CLI/skills.md#Investigation), [Sleight of Hand](/3-Mechanics/CLI/skills.md#Sleight%20of%20Hand), [Stealth](/3-Mechanics/CLI/skills.md#Stealth), or [Survival](/3-Mechanics/CLI/skills.md#Survival).
