...
Two town [guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) (LG male and female humans) stand just inside each gate. Instead of spears, they carry pikes (reach 10 ft., `dice:1d10+1|noform|noparens|avg` (`1d10 + 1`) piercing damage on a hit). These weapons are long enough to stab creatures through the bars of the gate. The guards greet all visitors with suspicion, particularly those who arrive at night. If the characters arrive at night, one or more of them must succeed on a DC 20 Charisma ([Persuasion](/3-Mechanics/CLI/skills.md#Persuasion)) check to convince the guards to unlock the gate and let them enter.
...
|-----------|----------|
| 1–3 | None |
| 4–5 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [swarms of rats](/3-Mechanics/CLI/bestiary/beast/swarm-of-rats-xmm.md) |
...
A house of Vallakian townsfolk contains `dice:1d4|noform|noparens|avg` (`1d4`) adults (male and female human [commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)) and `dice:1d8|noform|noparens|avg` (`1d8`)−1 children (male and female human noncombatants). Anyone who listens at the door hears chatter from within. Townsfolk won't willingly invite strangers into their homes, but they will speak with characters from behind closed doors or while standing in their vestibules.
...
From noon to dusk, the taproom holds `dice:2d4|noform|noparens|avg` (`2d4`) local patrons (male and female [commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)). Between dusk and midnight, `dice:2d8|noform|noparens|avg` (`2d8`) Vallakians are here. In addition, one or more of the following people might be present during this time.
...
For practice and for fun, Victor dug up some old cat bones behind the Wachter estate (see area N4) and animated them, creating six [cat skeletons](/3-Mechanics/CLI/bestiary/beast/cat-skeleton-cos.md) (use the [cat](/3-Mechanics/CLI/bestiary/beast/cat-xmm.md) stat block, but give them [darkvision](/3-Mechanics/CLI/senses.md#Darkvision) out to a range of 60 feet and immunity to poison damage, [exhaustion](/3-Mechanics/CLI/conditions.md#Exhaustion), and the [poisoned](/3-Mechanics/CLI/conditions.md#Poisoned) condition). The skeletons attack only when Victor commands them to.
...
Each of these wagons contains `dice:1d4|noform|noparens|avg` (`1d4`) sleeping Vistani (CN male and female human [bandits](/3-Mechanics/CLI/bestiary/humanoid/vistana-bandit-cos.md)). These Vistani wake up if their wagon is shaken or if they take damage and have at least 1 hit point remaining.
...
Each of these wagons contains one Vistani adult (male or female human [commoner](/3-Mechanics/CLI/bestiary/humanoid/vistana-commoner-cos.md)) and `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) Vistani children (male and female human noncombatants). The adult is watching the children playing games, teaching the children about their heritage, or telling a scary story to frighten the children.
