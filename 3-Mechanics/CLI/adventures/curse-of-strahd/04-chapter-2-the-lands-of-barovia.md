...
- The target is [blinded](/3-Mechanics/CLI/conditions.md#Blinded), [deafened](/3-Mechanics/CLI/conditions.md#Deafened), or both. When this curse ends, the Vistana takes `dice:5d6|noform|noparens|avg` (`5d6`) psychic damage.  
...
| d12 + d8 | Encounter |
|----------|-----------|
| 2 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [commoners](/3-Mechanics/CLI/bestiary/humanoid/barovian-commoner-cos.md) |
| 3 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [scouts](/3-Mechanics/CLI/bestiary/humanoid/barovian-scout-cos.md) |
| 4 | Hunting trap |
| 5 | Grave |
| 6 | False trail |
| 7 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [Vistani bandits](/3-Mechanics/CLI/bestiary/humanoid/vistana-bandit-cos.md) |
| 8 | Skeletal rider |
| 9 | Trinket |
| 10 | Hidden bundle |
| 11 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [swarm of ravens](/3-Mechanics/CLI/bestiary/beast/swarm-of-ravens-xmm.md) (50%) or 1 [wereraven](/3-Mechanics/CLI/bestiary/humanoid/wereraven-vrgr.md) (see appendix D) in raven form (50%) |
| 12 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [dire wolves](/3-Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md) |
| 13 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [wolves](/3-Mechanics/CLI/bestiary/beast/wolf-xmm.md) |
| 14 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [berserkers](/3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) |
| 15 | Corpse |
| 16 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [werewolves](/3-Mechanics/CLI/bestiary/monstrosity/werewolf-xmm.md) in human form |
| 17 | 1 [druid](/3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md) with `dice:2d6\|noform\|noparens\|avg` (`2d6`) [twig blights](/3-Mechanics/CLI/bestiary/plant/twig-blight-xmm.md) |
| 18 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [needle blights](/3-Mechanics/CLI/bestiary/plant/needle-blight-xmm.md) |
| 19 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [scarecrows](/3-Mechanics/CLI/bestiary/construct/scarecrow-xmm.md) |
...
| 7 | Hidden bundle |
| 8 | Skeletal rider |
| 9 | `dice:1d8\|noform\|noparens\|avg` (`1d8`) [swarm of bats](/3-Mechanics/CLI/bestiary/beast/swarm-of-bats-xmm.md) |
| 10 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [dire wolves](/3-Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md) |
| 11 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [wolves](/3-Mechanics/CLI/bestiary/beast/wolf-xmm.md) |
| 12 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [berserkers](/3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) |
| 13 | 1 [druid](/3-Mechanics/CLI/bestiary/humanoid/druid-xmm.md) and `dice:2d6\|noform\|noparens\|avg` (`2d6`) [twig blights](/3-Mechanics/CLI/bestiary/plant/twig-blight-xmm.md) |
| 14 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [needle blights](/3-Mechanics/CLI/bestiary/plant/needle-blight-xmm.md) |
| 15 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [werewolves](/3-Mechanics/CLI/bestiary/monstrosity/werewolf-xmm.md) in wolf form |
| 16 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [zombies](/3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) |
| 17 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [scarecrows](/3-Mechanics/CLI/bestiary/construct/scarecrow-xmm.md) |
| 18 | `dice:1d8\|noform\|noparens\|avg` (`1d8`) [Strahd zombies](/3-Mechanics/CLI/bestiary/undead/strahd-zombie-cos.md) (see appendix D) |
...
If the characters disturb the chest, `dice:3d6|noform|noparens|avg` (`3d6`) [zombies](/3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) erupt from the earthen floor and attack. Once the zombies appear, the will-o'-wisp becomes visible and joins the fray.
