...
The wooden chest in the hut is protected by a [glyph of warding](/3-Mechanics/CLI/spells/glyph-of-warding-xphb.md) that requires a successful DC 17 Intelligence ([Investigation](/3-Mechanics/CLI/skills.md#Investigation)) check to find. The glyph deals `dice:5d8|noform|noparens|avg` (`5d8`) thunder damage when triggered. Opening the lid releases four [crawling claws](/3-Mechanics/CLI/bestiary/undead/crawling-claw-xmm.md) that fight until destroyed. Also contained in the chest are various items that [Baba Lysaga](/3-Mechanics/CLI/bestiary/npc/baba-lysaga-cos.md) has taken from dead adventurers over the years:
