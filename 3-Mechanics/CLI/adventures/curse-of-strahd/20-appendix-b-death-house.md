...
Characters searching the footlocker find a folded [cloak of protection](/3-Mechanics/CLI/items/cloak-of-protection-xdmg.md), a small wooden coffer (unlocked) containing four [potions of healing](/3-Mechanics/CLI/items/potion-of-healing-xdmg.md), a [chain shirt](/3-Mechanics/CLI/items/chain-shirt-xphb.md), a mess kit, a [flask of alchemist's fire](/3-Mechanics/CLI/items/alchemists-fire-xphb.md), a [bullseye lantern](/3-Mechanics/CLI/items/bullseye-lantern-xphb.md), a [set of thieves' tools](/3-Mechanics/CLI/items/thieves-tools-xphb.md), and a spellbook with a yellow leather cover containing the following wizard spells:
