...
| 6 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [flying swords](/3-Mechanics/CLI/bestiary/construct/animated-flying-sword-xmm.md) |
| 7 | Blinsky toy |
| 8 | [Unseen servant](/3-Mechanics/CLI/spells/unseen-servant-xphb.md) |
| 9 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [commoners](/3-Mechanics/CLI/bestiary/humanoid/barovian-commoner-cos.md) |
| 10 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [crawling claws](/3-Mechanics/CLI/bestiary/undead/crawling-claw-xmm.md) |
| 11 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [shadows](/3-Mechanics/CLI/bestiary/undead/shadow-xmm.md) |
| 12 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [swarms of bats](/3-Mechanics/CLI/bestiary/beast/swarm-of-bats-xmm.md) |
| 13 | 1 crawling [Strahd zombie](/3-Mechanics/CLI/bestiary/undead/strahd-zombie-cos.md) (see appendix D) |
| 14 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) Vistani [thugs](/3-Mechanics/CLI/bestiary/humanoid/vistana-thug-cos.md) |
| 15 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [wights](/3-Mechanics/CLI/bestiary/undead/wight-xmm.md) |
| 16 | Trinket |
| 17 | Giant spider cocoon |
| 18 | 1 [Barovian witch](/3-Mechanics/CLI/bestiary/humanoid/barovian-witch-cos.md) (see appendix D) |
| 19 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [vampire spawn](/3-Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) |
...
[Rahadin](/3-Mechanics/CLI/bestiary/npc/rahadin-cos.md) directs the characters to a random location in the castle, determined by rolling a `dice:d6|noform|noparens|avg` (`d6`):
...
This unseen servant was created by Strahd and is permanent until destroyed (see the [unseen servant](/3-Mechanics/CLI/spells/unseen-servant-xphb.md) spell in the "Player's Handbook"). Roll a `dice:d6|noform|noparens|avg` (`d6`) to determine what the servant is carrying, or choose one of the options below.
...
| 2 | A silver goblet (worth 50 gp) filled to the brim with wine. A character who drinks the wine must make a DC 15 Constitution saving throw, taking `dice:8d10\|noform\|noparens\|avg\|text(44)` (`8d10`) poison damage on a failed save, or half as much damage on a successful one. On future occurrences of this encounter, the wine acts as a [potion of healing](/3-Mechanics/CLI/items/potion-of-healing-xdmg.md). |
...
| 5 | A crystal dinner bell (worth 25 gp). The unseen servant rings the bell if the characters come within 10 feet of it. The sound attracts `dice:1d4\|noform\|noparens\|avg` (`1d4`) hungry [vampire spawn](/3-Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) (see below), which arrive in `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) rounds. |
...
The statuette on the altar is an artifact called the [Icon of Ravenloft](/3-Mechanics/CLI/items/icon-of-ravenloft-cos.md) (see appendix C). Any evil creature that touches the statuette must make a DC 17 Constitution saving throw, taking `dice:16d10|noform|noparens|avg|text(88)` (`16d10`) radiant damage on a failed save, or half as much damage on a successful one. The statuette is safe for all creatures to handle once it is no longer in contact with the altar.
...
| dice: d4 | Creature |
|----------|----------|
| 1 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [shadows](/3-Mechanics/CLI/bestiary/undead/shadow-xmm.md) |
| 2 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [vampire spawn](/3-Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) |
| 3 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [wights](/3-Mechanics/CLI/bestiary/undead/wight-xmm.md) |
| 4 | 1 [wraith](/3-Mechanics/CLI/bestiary/undead/wraith-xmm.md) and `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [specters](/3-Mechanics/CLI/bestiary/undead/specter-xmm.md) |
^creature
...
There is no danger in this area during the day. But if the characters try to take a short rest here during the night, the rest is interrupted by the arrival of `dice:1d4|noform|noparens|avg` (`1d4`) [Barovian witches](/3-Mechanics/CLI/bestiary/humanoid/barovian-witch-cos.md) from area K56. They try to subdue the party with [sleep](/3-Mechanics/CLI/spells/sleep-xphb.md) spells. A witch retreats to area K56 if wounded.
...
The catacombs are home to tens of thousands of bats. The bats hang here during daytime hours and fly out in the evening through the high tower's central shaft (area K18a) to hunt at night. They will not attack intruders unless they are provoked or are specifically commanded to do so by Strahd. If one or more bats within a 10-foot square on the map are attacked or caught in the area of a harmful spell, `dice:2d4|noform|noparens|avg` (`2d4`) [swarms of bats](/3-Mechanics/CLI/bestiary/beast/swarm-of-bats-xmm.md) form in that area and attack. No more swarms can be formed in that square until the next dawn, when more bats arrive to replenish those that were killed.
