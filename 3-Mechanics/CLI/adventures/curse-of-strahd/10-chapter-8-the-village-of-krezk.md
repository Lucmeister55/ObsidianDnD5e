...
A typical cottage is only 200 square feet yet contains `dice:1d4|noform|noparens|avg` (`1d4`) adults (male and female human [commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)), `dice:1d4|noform|noparens|avg` (`1d4`)−1 children (male and female human noncombatants), plus the family's pigs, hares, and chickens.
