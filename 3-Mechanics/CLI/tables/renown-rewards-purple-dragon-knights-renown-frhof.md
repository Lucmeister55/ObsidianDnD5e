...
| 15+ | You are given an honorary Cormyrean knighthood. The royal family of Cormyr is [Friendly](/3-Mechanics/CLI/variant-rules/friendly-attitude-xphb.md) to you by default. |
| 25+ | Amethyst dragons are Friendly to you by default. |
| 30+ | You can command a troop of `dice:1d6\|noform\|noparens\|avg` (`1d6`) [Knights](/3-Mechanics/CLI/bestiary/humanoid/knight-xmm.md) to help you on a mission or complete one task that doesn't go against the Purple Dragon Knights' core principles. Once you use this reward, you can't do so again until your Renown Score increases. |
